...
CRITICAL PATH = G1 exact-byte custody; G2 BP/listing/date provenance; G3 CA/calendar/annotation governed inputs; validation is not on the active path  
LAST MATERIAL PROGRESS = all three non-validator workers completed and exact reports were committed; no gate advance was claimed
...
| G2 | 28% (7/25 EWU) | documentary reconciliation done with blocker; 514/date provenance remain active |
| G3 | 16% (4/25 EWU) | non-validator assessment complete; CA threshold, independent KRX universe, governed calendar and annotation inputs blocked |
...
- All three successor non-validator workers have completed; active worker/validator count is `0/0`.
