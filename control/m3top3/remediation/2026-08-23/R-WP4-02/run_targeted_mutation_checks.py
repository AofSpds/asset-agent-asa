...
MUTATIONS = [
    ...
    Mutation("MUT-OFFICIAL-DIAGNOSTIC", "tools/m3top3/admission.py", 'if getattr(scorer, "model_id", None) == "DIAGNOSTIC_FIXTURE" or scorer.__class__.__name__.lower().startswith("diagnostic"):', 'if False:', "tools.m3top3.tests.test_known_failures_model_admission.KnownFailureModelAdmissionTests.test_kf_mod_002_diagnostic_scorer_denied_in_official_mode"),
]
