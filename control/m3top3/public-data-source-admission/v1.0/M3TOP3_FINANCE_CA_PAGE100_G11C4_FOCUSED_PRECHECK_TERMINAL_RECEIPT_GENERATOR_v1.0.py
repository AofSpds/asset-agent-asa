#!/usr/bin/env python3
"""Build a fail-closed G11C4 focused PRECHECK terminal receipt.
...
Usage:
    python M3TOP3_FINANCE_CA_PAGE100_G11C4_FOCUSED_PRECHECK_TERMINAL_RECEIPT_GENERATOR_v1.0.py \
...
EXPECTED_ACTIVATION_PATH = (
    ...
    "M3TOP3_FINANCE_CA_PAGE100_G11C4_ELIGIBLE_SUCCESSOR_PRECHECK_ACTIVATION_v1.0.json"
)
EXPECTED_ACTIVATION_MESSAGE = (
    "Arm M3Top3 Finance Page100 G11C4 focused PRECHECK 20260901143300 v1.0"
)
EXPECTED_WORKFLOW_REF = (
    "AofSpds/asset-agent-asa/.github/workflows/"
    "m3top3-finance-page100-g11c4-eligible-successor-precheck-v1.yml@"
...
EXPECTED_AUTHORITY_BASE_COMMIT = "8b6cfcb03904e58c5ffabb3ff3c10cb5d6850444"
EXPECTED_AUTHORITY_BASE_TREE = "27af43d2d49476ce552e5c59010bac93c890c194"
...
EXPECTED_G11C3_TERMINAL_RECEIPT_PATH = (
    "control/m3top3/public-data-source-admission/v1.0/"
    "M3TOP3_FINANCE_CA_PAGE100_G11C3_ELIGIBLE_SUCCESSOR_LIVE_TERMINAL_"
    "RECEIPT_33473465774_v1.0.json"
)
EXPECTED_G11C3_TERMINAL_RECEIPT_APPEND_COMMIT = (
    "8b6cfcb03904e58c5ffabb3ff3c10cb5d6850444"
)
EXPECTED_G11C3_TERMINAL_RECEIPT_APPEND_TREE = (
    "27af43d2d49476ce552e5c59010bac93c890c194"
)
EXPECTED_G11C3_TERMINAL_RECEIPT_GIT_BLOB = (
    "9ccc1ac5a381dea3a9ba18fdabb357330fc35a42"
)
EXPECTED_G11C3_TERMINAL_RECEIPT_SHA256 = (
    "846a915b72f428db2155d316eb075aafa05840b5a277e3e9f2c4a54092dc6c3f"
)
EXPECTED_G11C3_TERMINAL_RECEIPT_PAYLOAD_SHA256 = (
    "ee49c0b5fe739dd9830250e84659780fbefc7e902021200b7ce0c2b334c5630c"
)
EXPECTED_G11C3_TERMINAL_RECEIPT_BYTES = 10375
EXPECTED_G11C3_PRECHECK_RUN_ID = 33472741288
EXPECTED_G11C3_LIVE_RUN_ID = 33473465774
BASE_DATE = "20240131"
...
REQUIRED_CHECKS = (
    ...
    "predecessor_g11c3_terminal_failure_exactly_bound_and_no_rerun",
...
def _validate_candidate(candidate: dict[str, Any]) -> tuple[bool, list[str]]:
    ...
    expected_material_paths = {
        "authority_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C4_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0.json",
        "plan_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C4_ELIGIBLE_SUCCESSOR_PLAN_v1.0.json",
        "seed_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C4_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0.json",
        "manifest_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C4_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0.json",
        "workflow_path": ".github/workflows/m3top3-finance-page100-g11c4-eligible-successor-precheck-v1.yml",
        "runner_path": "tools/m3top3/finance_page100_g11c4_selector_successor.py",
        "tests_path": "tools/m3top3/tests/test_finance_page100_g11c4_selector_successor.py",
    }
    for key, expected in expected_material_paths.items():
        if authority.get(key) != expected:
            failures.append(f"authority_binding.{key}_mismatch")

    predecessor_g11c3 = _require_mapping(
        candidate, "predecessor_terminal_g11c3_binding"
    )
    for key in (
        "generation_id",
        "runtime_lock_id",
    ...
    exact_predecessor_g11c3 = {
        ...
        "terminal_receipt_append_commit": EXPECTED_G11C3_TERMINAL_RECEIPT_APPEND_COMMIT,
        "terminal_receipt_append_tree": EXPECTED_G11C3_TERMINAL_RECEIPT_APPEND_TREE,
        "terminal_receipt_path": EXPECTED_G11C3_TERMINAL_RECEIPT_PATH,
        "terminal_receipt_git_blob": EXPECTED_G11C3_TERMINAL_RECEIPT_GIT_BLOB,
        "terminal_receipt_sha256": EXPECTED_G11C3_TERMINAL_RECEIPT_SHA256,
        "terminal_receipt_payload_sha256": EXPECTED_G11C3_TERMINAL_RECEIPT_PAYLOAD_SHA256,
        "terminal_receipt_bytes": EXPECTED_G11C3_TERMINAL_RECEIPT_BYTES,
        "precheck_run_id": EXPECTED_G11C3_PRECHECK_RUN_ID,
        "live_run_id": EXPECTED_G11C3_LIVE_RUN_ID,
        "credentials_issued": False,
        "runner_started": False,
        "reuse_authorized": False,
    }
    for key, expected in exact_predecessor_g11c3.items():
        if predecessor_g11c3.get(key) != expected:
            failures.append(f"predecessor_terminal_g11c3_binding.{key}_mismatch")
    ...
    exact_route_values = {
        ...
        "maximum_new_g11c4_primary_acquisitions": 1696,
        "aggregate_max_network_attempts_total": 2000,
        "inherited_g10_network_attempts": 4,
        "maximum_new_g11c4_network_attempts": 1996,
    }
...
def build_receipt(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    terminal_state = (
        "TERMINAL_PASS_FOCUSED_G11C4_PRECHECK_EXACT_3_OIDC_STS_POLICY_PACKING_PROBES_SUCCESS_ZERO_DOWNSTREAM_MUTATION_LIVE_NOT_AUTHORIZED"
        if passed
        else "TERMINAL_FAIL_CLOSED_FOCUSED_G11C4_PRECHECK_LIVE_NOT_AUTHORIZED"
    )

    receipt: dict[str, Any] = {
        "artifact": f"M3TOP3_FINANCE_CA_PAGE100_G11C4_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        "artifact_kind": "FRESH_G11C4_ELIGIBLE_SUCCESSOR_FOCUSED_PRECHECK_TERMINAL_RECEIPT",
        "schema_version": 1,
        ...
        "artifact_identity": {
            "artifact_id": f"M3TOP3_FINANCE_CA_PAGE100_G11C4_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        ...
        "project_context": {
            ...
            "validation_claim": "FOCUSED_G11C4_PRECHECK_POLICY_PACKING_PROBES_ONLY",
        },
        "lineage": {
            "s2": {
                "run_id": "33403101817",
        ...
        "predecessor_terminal_g11c3_binding": candidate[
        ...
        "claim_ceiling": {
            "validation_claim": (
                "FOCUSED_G11C4_PRECHECK_POLICY_PACKING_PROBES_ONLY"
                if passed else "NONE"
            ),
