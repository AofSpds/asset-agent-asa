#!/usr/bin/env python3
"""Build a fail-closed G11 focused PRECHECK terminal receipt.
...
Usage:
    python M3TOP3_FINANCE_CA_PAGE100_G11_FOCUSED_PRECHECK_TERMINAL_RECEIPT_GENERATOR_v1.0.py \
...
EXPECTED_ACTIVATION_PATH = (
    ...
    "M3TOP3_FINANCE_CA_PAGE100_G11_ELIGIBLE_SUCCESSOR_PRECHECK_ACTIVATION_v1.0.json"
)
EXPECTED_ACTIVATION_MESSAGE = (
    "Arm M3Top3 Finance Page100 G11 focused PRECHECK 20260901110618 v1.0"
)
EXPECTED_WORKFLOW_REF = (
    "AofSpds/asset-agent-asa/.github/workflows/"
    "m3top3-finance-page100-g11-eligible-successor-precheck-v1.yml@"
...
def _validate_candidate(candidate: dict[str, Any]) -> tuple[bool, list[str]]:
    ...
    expected_material_paths = {
        "authority_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0.json",
        "plan_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11_ELIGIBLE_SUCCESSOR_PLAN_v1.0.json",
        "seed_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0.json",
        "manifest_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0.json",
        "precheck_session_policy_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11_PRECHECK_SESSION_POLICY_v1.0.json",
        "live_session_policy_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11_LIVE_SESSION_POLICY_v1.0.json",
        "workflow_path": ".github/workflows/m3top3-finance-page100-g11-eligible-successor-precheck-v1.yml",
        "runner_path": "tools/m3top3/finance_page100_g11_selector_successor.py",
        "tests_path": "tools/m3top3/tests/test_finance_page100_g11_selector_successor.py",
    }
    ...
    exact_identities = {
        "generation_id": "FINANCE-PAGE100-G11-20260901110618",
        "runtime_lock_id": "PMO-FINANCE-PAGE100-G11-20260901110618",
        "pilot_run_id": "FINANCE-PAGE100-PILOT-G11-20260901110618",
        "precheck_act_id": "FINANCE-PAGE100-PRECHECK-ACT-G11-20260901110618",
        "live_act_id": "FINANCE-PAGE100-LIVE-ACT-G11-20260901110618",
        "latch_event_id": "FINANCE-PAGE100-LATCH-G11-20260901110618",
    }
...
def build_receipt(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    terminal_state = (
        ...
        if passed
        else "TERMINAL_FAIL_CLOSED_FOCUSED_G11_PRECHECK_LIVE_NOT_AUTHORIZED"
    )

    receipt: dict[str, Any] = {
        "artifact": f"M3TOP3_FINANCE_CA_PAGE100_G11_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        "artifact_kind": "FRESH_G11_ELIGIBLE_SUCCESSOR_FOCUSED_PRECHECK_TERMINAL_RECEIPT",
        "schema_version": 1,
        ...
        "artifact_identity": {
            "artifact_id": f"M3TOP3_FINANCE_CA_PAGE100_G11_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        ...
        "project_context": {
            ...
            "validation_claim": "FOCUSED_G11_PRECHECK_ONLY",
        },
        "lineage": {
            "s2": {
                "run_id": "33403101817",
        ...
        "claim_ceiling": {
            "validation_claim": "FOCUSED_G11_PRECHECK_ONLY" if passed else "NONE",
            "source_admission_verdict": "NOT_ADMITTED",
            "g2_pass": False,
            "g3_pass": False,
            "issuer_identity_resolved": False,
