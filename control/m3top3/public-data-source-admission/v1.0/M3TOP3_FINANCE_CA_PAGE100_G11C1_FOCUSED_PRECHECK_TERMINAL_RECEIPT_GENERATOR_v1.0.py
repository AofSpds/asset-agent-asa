#!/usr/bin/env python3
"""Build a fail-closed G11C1 focused PRECHECK terminal receipt.

The generator records observations; it does not perform network, provider, quota,
AWS, S3, GitHub, or repository mutations.  A PASS receipt establishes only that
the focused PRECHECK completed with zero mutation effects.  It can never grant
LIVE authority or activate LIVE execution.

Usage:
    python M3TOP3_FINANCE_CA_PAGE100_G11C1_FOCUSED_PRECHECK_TERMINAL_RECEIPT_GENERATOR_v1.0.py \
...
EXPECTED_ACTIVATION_PATH = (
    ...
    "M3TOP3_FINANCE_CA_PAGE100_G11C1_ELIGIBLE_SUCCESSOR_PRECHECK_ACTIVATION_v1.0.json"
)
EXPECTED_ACTIVATION_MESSAGE = (
    "Arm M3Top3 Finance Page100 G11C1 focused PRECHECK 20260901123521 v1.0"
)
EXPECTED_WORKFLOW_REF = (
    "AofSpds/asset-agent-asa/.github/workflows/"
    "m3top3-finance-page100-g11c1-eligible-successor-precheck-v1.yml@"
...
EXPECTED_AUTHORITY_BASE_COMMIT = "e8b0b93714060627b2fbc124566eb6a5b32cf9d5"
EXPECTED_AUTHORITY_BASE_TREE = "0d4465091a680c1ac9ad6c7aed3aed8f606f57ea"
EXPECTED_AUTHORITY_SHA256 = (
    "321ce03b99ec07850c73f8bb857cfa290f15dd59850b196d2a0f6f1838bbfcf6"
)
EXPECTED_AUTHORITY_GIT_BLOB = "41de64997658bae40aa9b2e17be311a301df879b"
EXPECTED_OWNER_CAP_SPEC_SHA256 = (
...
def _validate_candidate(candidate: dict[str, Any]) -> tuple[bool, list[str]]:
    ...
    for key in (
        ...
        "seed_path",
        "manifest_path",
        "precheck_session_policy_path",
        "live_session_policy_path",
        "workflow_path",
        "runner_path",
        "tests_path",
    ...
    for key in (
        ...
        "seed_sha256",
        "manifest_sha256",
        "precheck_session_policy_sha256",
        "live_session_policy_sha256",
        "workflow_sha256",
        "runner_sha256",
        "tests_sha256",
    ...
    exact_authority_values = {
        ...
        "authority_git_blob": EXPECTED_AUTHORITY_GIT_BLOB,
        ...
        "owner_cap_spec_sha256": EXPECTED_OWNER_CAP_SPEC_SHA256,
        "execution_token_sha256": EXPECTED_EXECUTION_TOKEN_SHA256,
    ...
    expected_material_paths = {
        "authority_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C1_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0.json",
        "plan_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C1_ELIGIBLE_SUCCESSOR_PLAN_v1.0.json",
        "seed_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C1_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0.json",
        "manifest_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C1_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0.json",
        "precheck_session_policy_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C1_PRECHECK_SESSION_POLICY_v1.0.json",
        "live_session_policy_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C1_LIVE_SESSION_POLICY_v1.0.json",
        "workflow_path": ".github/workflows/m3top3-finance-page100-g11c1-eligible-successor-precheck-v1.yml",
        "runner_path": "tools/m3top3/finance_page100_g11c1_selector_successor.py",
        "tests_path": "tools/m3top3/tests/test_finance_page100_g11c1_selector_successor.py",
    }
    ...
    exact_identities = {
        "generation_id": "FINANCE-PAGE100-G11C1-20260901123521",
        "runtime_lock_id": "PMO-FINANCE-PAGE100-G11C1-20260901123521",
        "pilot_run_id": "FINANCE-PAGE100-PILOT-G11C1-20260901123521",
        "precheck_act_id": "FINANCE-PAGE100-PRECHECK-ACT-G11C1-20260901123521",
        "live_act_id": "FINANCE-PAGE100-LIVE-ACT-G11C1-20260901123521",
        "latch_event_id": "FINANCE-PAGE100-LATCH-G11C1-20260901123521",
    }
    ...
    if identities.get("owner_cap_spec_sha256") != EXPECTED_OWNER_CAP_SPEC_SHA256:
        failures.append("fresh_identity_binding.owner_cap_spec_sha256_mismatch")
    if identities.get("execution_token_sha256") != EXPECTED_EXECUTION_TOKEN_SHA256:
        failures.append("fresh_identity_binding.execution_token_sha256_mismatch")
    ...
    exact_route_values = {
        ...
        "maximum_new_g11c1_primary_acquisitions": 1696,
        "aggregate_max_network_attempts_total": 2000,
        "inherited_g10_network_attempts": 4,
        "maximum_new_g11c1_network_attempts": 1996,
    }
    ...
    for effect in ZERO_MUTATION_EFFECTS:
        value = effects.get(effect)
        if type(value) is not int or value < 0:
            raise ReceiptError(f"observed_effects.{effect} must be a non-negative integer")
        if value != 0:
            failures.append(f"observed_effects.{effect}_must_equal_0")
    if effects.get("effects_reconciled") is not True:
        failures.append("observed_effects.effects_reconciled_must_be_true")
    if effects.get("ambiguous_side_effects") is not False:
        failures.append("observed_effects.ambiguous_side_effects_must_be_false")
    ...
    if observations.get("aws_read_calls") != 0:
        failures.append("read_only_observations.aws_read_calls_must_equal_0")
    ...
    if not isinstance(observed_no_rerun_runs, list) or set(observed_no_rerun_runs) != required_no_rerun_runs:
...
def build_receipt(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    terminal_state = (
        ...
        if passed
        else "TERMINAL_FAIL_CLOSED_FOCUSED_G11C1_PRECHECK_LIVE_NOT_AUTHORIZED"
    )

    receipt: dict[str, Any] = {
        "artifact": f"M3TOP3_FINANCE_CA_PAGE100_G11C1_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        "artifact_kind": "FRESH_G11C1_ELIGIBLE_SUCCESSOR_FOCUSED_PRECHECK_TERMINAL_RECEIPT",
        "schema_version": 1,
        ...
        "artifact_identity": {
            "artifact_id": f"M3TOP3_FINANCE_CA_PAGE100_G11C1_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        ...
        "project_context": {
            ...
            "validation_claim": "FOCUSED_G11C1_PRECHECK_ONLY",
        },
        "lineage": {
            "s2": {
                "run_id": "33403101817",
        ...
        "effect_reconciliation": {
            ...
            "aws_calls": candidate["read_only_observations"]["aws_read_calls"],
            "s3_calls": candidate["read_only_observations"]["s3_read_calls"],
        ...
        "claim_ceiling": {
            "validation_claim": "FOCUSED_G11C1_PRECHECK_ONLY" if passed else "NONE",
            "source_admission_verdict": "NOT_ADMITTED",
            "g2_pass": False,
            "g3_pass": False,
            "issuer_identity_resolved": False,
