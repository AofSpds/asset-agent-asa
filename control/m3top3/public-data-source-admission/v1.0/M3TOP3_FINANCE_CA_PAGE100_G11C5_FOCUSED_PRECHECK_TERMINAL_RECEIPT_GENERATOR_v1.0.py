#!/usr/bin/env python3
"""Build a fail-closed G11C5 focused PRECHECK terminal receipt.
...
Usage:
    python M3TOP3_FINANCE_CA_PAGE100_G11C5_FOCUSED_PRECHECK_TERMINAL_RECEIPT_GENERATOR_v1.0.py \
...
EXPECTED_ACTIVATION_PATH = (
    ...
    "M3TOP3_FINANCE_CA_PAGE100_G11C5_ELIGIBLE_SUCCESSOR_PRECHECK_ACTIVATION_v1.0.json"
)
EXPECTED_ACTIVATION_MESSAGE = (
    "Arm M3Top3 Finance Page100 G11C5 focused PRECHECK 20260901152200 v1.0"
)
EXPECTED_WORKFLOW_REF = (
    "AofSpds/asset-agent-asa/.github/workflows/"
    "m3top3-finance-page100-g11c5-eligible-successor-precheck-v1.yml@"
...
EXPECTED_AUTHORITY_BASE_COMMIT = "6e4660cfbb1730dcaeaa2908c9e1a38de012a920"
EXPECTED_AUTHORITY_BASE_TREE = "3e4a53a6df8ac7fa4f500c51a951ae9c900476d8"
...
def _validate_candidate(candidate: dict[str, Any]) -> tuple[bool, list[str]]:
    ...
    expected_material_paths = {
        "authority_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C5_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0.json",
        "plan_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C5_ELIGIBLE_SUCCESSOR_PLAN_v1.0.json",
        "seed_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C5_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0.json",
        "manifest_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C5_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0.json",
        "workflow_path": ".github/workflows/m3top3-finance-page100-g11c5-eligible-successor-precheck-v1.yml",
        "runner_path": "tools/m3top3/finance_page100_g11c5_selector_successor.py",
        "tests_path": "tools/m3top3/tests/test_finance_page100_g11c5_selector_successor.py",
    }
    ...
    exact_route_values = {
        ...
        "maximum_new_g11c5_primary_acquisitions": 1696,
        "aggregate_max_network_attempts_total": 2000,
        "inherited_g10_network_attempts": 4,
        "maximum_new_g11c5_network_attempts": 1996,
    }
...
def build_receipt(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    terminal_state = (
        "TERMINAL_PASS_FOCUSED_G11C5_PRECHECK_EXACT_3_OIDC_STS_POLICY_PACKING_PROBES_SUCCESS_ZERO_DOWNSTREAM_MUTATION_LIVE_NOT_AUTHORIZED"
        if passed
        else "TERMINAL_FAIL_CLOSED_FOCUSED_G11C5_PRECHECK_LIVE_NOT_AUTHORIZED"
    )

    receipt: dict[str, Any] = {
        "artifact": f"M3TOP3_FINANCE_CA_PAGE100_G11C5_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        "artifact_kind": "FRESH_G11C5_ELIGIBLE_SUCCESSOR_FOCUSED_PRECHECK_TERMINAL_RECEIPT",
        "schema_version": 1,
        ...
        "artifact_identity": {
            "artifact_id": f"M3TOP3_FINANCE_CA_PAGE100_G11C5_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        ...
        "project_context": {
            ...
            "validation_claim": "FOCUSED_G11C5_PRECHECK_POLICY_PACKING_PROBES_ONLY",
        },
        "lineage": {
            "s2": {
                "run_id": "33403101817",
        ...
        "claim_ceiling": {
            "validation_claim": (
                "FOCUSED_G11C5_PRECHECK_POLICY_PACKING_PROBES_ONLY"
                if passed else "NONE"
            ),
