#!/usr/bin/env python3
"""Build a fail-closed G11C2 focused PRECHECK terminal receipt.
...
Usage:
    python M3TOP3_FINANCE_CA_PAGE100_G11C2_FOCUSED_PRECHECK_TERMINAL_RECEIPT_GENERATOR_v1.0.py \
...
EXPECTED_ACTIVATION_PATH = (
    ...
    "M3TOP3_FINANCE_CA_PAGE100_G11C2_ELIGIBLE_SUCCESSOR_PRECHECK_ACTIVATION_v1.0.json"
)
EXPECTED_ACTIVATION_MESSAGE = (
    "Arm M3Top3 Finance Page100 G11C2 focused PRECHECK 20260901130250 v1.0"
)
EXPECTED_WORKFLOW_REF = (
    "AofSpds/asset-agent-asa/.github/workflows/"
    "m3top3-finance-page100-g11c2-eligible-successor-precheck-v1.yml@"
...
EXPECTED_AUTHORITY_BASE_COMMIT = "c7efa70b02249fb70a1f076a585e17a5b45c90c0"
EXPECTED_AUTHORITY_BASE_TREE = "39aad4f2412c48fc16425c7d929d7410545a1b59"
EXPECTED_AUTHORITY_SHA256 = (
    "26219d8f7d0235eeefdbfb9815b26b79d6046ece23579211a30d4bae2e262f6d"
)
EXPECTED_AUTHORITY_GIT_BLOB = "51811e39070edc4c174e6eb841f913cceb37416b"
...
def _validate_candidate(candidate: dict[str, Any]) -> tuple[bool, list[str]]:
    ...
    expected_material_paths = {
        "authority_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C2_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0.json",
        "plan_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C2_ELIGIBLE_SUCCESSOR_PLAN_v1.0.json",
        "seed_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C2_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0.json",
        "manifest_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C2_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0.json",
        "precheck_session_policy_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C2_PRECHECK_SESSION_POLICY_v1.0.json",
        "live_session_policy_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C2_LIVE_SESSION_POLICY_v1.0.json",
        "workflow_path": ".github/workflows/m3top3-finance-page100-g11c2-eligible-successor-precheck-v1.yml",
        "runner_path": "tools/m3top3/finance_page100_g11c2_selector_successor.py",
        "tests_path": "tools/m3top3/tests/test_finance_page100_g11c2_selector_successor.py",
    }
    ...
    exact_route_values = {
        ...
        "maximum_new_g11c2_primary_acquisitions": 1696,
        "aggregate_max_network_attempts_total": 2000,
        "inherited_g10_network_attempts": 4,
        "maximum_new_g11c2_network_attempts": 1996,
    }
...
def build_receipt(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    terminal_state = (
        ...
        if passed
        else "TERMINAL_FAIL_CLOSED_FOCUSED_G11C2_PRECHECK_LIVE_NOT_AUTHORIZED"
    )

    receipt: dict[str, Any] = {
        "artifact": f"M3TOP3_FINANCE_CA_PAGE100_G11C2_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        "artifact_kind": "FRESH_G11C2_ELIGIBLE_SUCCESSOR_FOCUSED_PRECHECK_TERMINAL_RECEIPT",
        "schema_version": 1,
        ...
        "artifact_identity": {
            "artifact_id": f"M3TOP3_FINANCE_CA_PAGE100_G11C2_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        ...
        "project_context": {
            ...
            "validation_claim": "FOCUSED_G11C2_PRECHECK_ONLY",
        },
        "lineage": {
            "s2": {
                "run_id": "33403101817",
        ...
        "claim_ceiling": {
            "validation_claim": "FOCUSED_G11C2_PRECHECK_ONLY" if passed else "NONE",
            "source_admission_verdict": "NOT_ADMITTED",
            "g2_pass": False,
            "g3_pass": False,
            "issuer_identity_resolved": False,
