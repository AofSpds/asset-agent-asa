#!/usr/bin/env python3
"""Build a fail-closed G11C9 focused PRECHECK terminal receipt.
...
Usage:
    python M3TOP3_FINANCE_CA_PAGE100_G11C9_FOCUSED_PRECHECK_TERMINAL_RECEIPT_GENERATOR_v1.0.py \
...
EXPECTED_ACTIVATION_PATH = (
    ...
    "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_PRECHECK_ACTIVATION_v1.0.json"
)
EXPECTED_ACTIVATION_MESSAGE = (
    "Arm M3Top3 Finance Page100 G11C9 focused PRECHECK 20260901200940 v1.0"
)
EXPECTED_WORKFLOW_REF = (
    "AofSpds/asset-agent-asa/.github/workflows/"
    "m3top3-finance-page100-g11c9-eligible-successor-precheck-v1.yml@"
...
EXPECTED_AUTHORITY_BASE_COMMIT = "39a674ac8fc2d6af25e23f533f9f3379f81e4b6c"
EXPECTED_AUTHORITY_BASE_TREE = "9f3905bd6aa25617c5b2f93e137a9ac281c3dc7b"
EXPECTED_G11C7_BINDING_CANONICAL_SHA256 = (
    "890744be59404e7c7d5b132a2e49af0d14fbe7044032e8cf6caecef8e2549912"
)
EXPECTED_G11C8_BINDING_CANONICAL_SHA256 = (
    "eeff6a3bde96363658f2da63017fa2148dbf35c5b95fe88bd4ea652cfdbc0dd4"
)
...
REQUIRED_CHECKS = (
    ...
    "predecessor_g11c7_shallow_history_terminal_failure_exactly_bound_and_no_rerun",
    "predecessor_g11c8_pre_live_contract_invalidation_exactly_bound_and_no_rerun",
    "ordered17_no_rerun_producer_schema_consumer_contract_verified",
    "bounded_fetch_depth_33_and_pre_oidc_lineage_availability_verified",
...
def _validate_candidate(candidate: dict[str, Any]) -> tuple[bool, list[str]]:
    ...
    expected_material_paths = {
        "authority_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0.json",
        "plan_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_PLAN_v1.0.json",
        "seed_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0.json",
        "manifest_path": "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0.json",
    ...
    predecessor_g11c7 = _require_mapping(
        candidate, "predecessor_terminal_g11c7_binding"
    )
    if hashlib.sha256(_canonical_bytes(predecessor_g11c7)).hexdigest() != (
        EXPECTED_G11C7_BINDING_CANONICAL_SHA256
    ):
        failures.append("predecessor_terminal_g11c7_binding.exact_binding_mismatch")

    predecessor_g11c8 = _require_mapping(
        candidate, "predecessor_invalidated_g11c8_binding"
    )
    if hashlib.sha256(_canonical_bytes(predecessor_g11c8)).hexdigest() != (
        EXPECTED_G11C8_BINDING_CANONICAL_SHA256
    ):
        failures.append("predecessor_invalidated_g11c8_binding.exact_binding_mismatch")
    ...
    exact_identities = {
        "generation_id": "FINANCE-PAGE100-G11C9-20260901200940",
        "runtime_lock_id": "PMO-FINANCE-PAGE100-G11C9-20260901200940",
        "pilot_run_id": "FINANCE-PAGE100-PILOT-G11C9-20260901200940",
        "preparation_id": "FINANCE-PAGE100-G11C9-PREPARATION-20260901200940",
        "precheck_act_id": "FINANCE-PAGE100-PRECHECK-ACT-G11C9-20260901200940",
        "live_act_id": "FINANCE-PAGE100-LIVE-ACT-G11C9-20260901200940",
        "latch_event_id": "FINANCE-PAGE100-LATCH-G11C9-20260901200940",
    }
    ...
    exact_route_values = {
        ...
        "maximum_new_g11c9_primary_acquisitions": 1696,
        "aggregate_max_network_attempts_total": 2000,
        "inherited_g10_network_attempts": 4,
        "maximum_new_g11c9_network_attempts": 1996,
    }
    ...
    if runner_observations.get("active_prefix_rejection_regressions") != [
        "G11", "G11C1", "G11C2", "G11C3", "G11C4", "G11C5", "G11C6", "G11C7", "G11C8",
    ]:
        failures.append(
            "runner_result.observations.active_prefix_rejection_regressions_mismatch"
        )
...
def build_receipt(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    terminal_state = (
        "TERMINAL_PASS_FOCUSED_G11C9_PRECHECK_EXACT_3_OIDC_STS_POLICY_PACKING_PROBES_SUCCESS_ZERO_DOWNSTREAM_MUTATION_LIVE_NOT_AUTHORIZED"
        if passed
        else "TERMINAL_FAIL_CLOSED_FOCUSED_G11C9_PRECHECK_LIVE_NOT_AUTHORIZED"
    )

    receipt: dict[str, Any] = {
        "artifact": f"M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        "artifact_kind": "FRESH_G11C9_ELIGIBLE_SUCCESSOR_FOCUSED_PRECHECK_TERMINAL_RECEIPT",
        "schema_version": 1,
        ...
        "artifact_identity": {
            "artifact_id": f"M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_PRECHECK_TERMINAL_RECEIPT_{candidate['execution_binding']['run_id']}_v1.0",
        ...
        "project_context": {
            ...
            "validation_claim": "FOCUSED_G11C9_PRECHECK_POLICY_PACKING_PROBES_ONLY",
        },
        "lineage": {
            "s2": {
                "run_id": "33403101817",
            ...
            "g11c7_defect_code": "CHECKOUT_FETCH_DEPTH_10_OMITS_BOUND_G11C1_COMMIT_OBJECT",
            "g11c7_credentials_issued": 0,
            "g11c7_runner_started": False,
            "g11c7_live_execution_started": False,
            "g11c7_reuse_authorized": False,
            ...
            "g11c8_reuse_authorized": False,
            "c9_checkout_fetch_depth": 33,
            "c9_minimum_required_precheck_fetch_depth": 31,
            "c9_minimum_required_live_fetch_depth": 33,
        ...
        "predecessor_terminal_g11c7_binding": candidate[
            "predecessor_terminal_g11c7_binding"
        ],
        "predecessor_invalidated_g11c8_binding": candidate[
        ...
        "claim_ceiling": {
            "validation_claim": (
                "FOCUSED_G11C9_PRECHECK_POLICY_PACKING_PROBES_ONLY"
                if passed else "NONE"
            ),
        ...
        "no_rerun": {
            ...
            "consumed_github_runs": list(REQUIRED_NO_RERUN_RUNS),
            "g11c6_precheck_run_id": "33484842311",
            "g11c6_precheck_job_id": "99782407546",
            "g11c6_precheck_run_attempt": 1,
            ...
            "consumed_runtime_lock_ids": [
                ...
                "PMO-FINANCE-PAGE100-G11C7-20260901171500",
                "PMO-FINANCE-PAGE100-G11C8-20260901184500",
            ],
            "consumed_pilot_run_ids": [
                ...
                "FINANCE-PAGE100-PILOT-G11C7-20260901171500",
                "FINANCE-PAGE100-PILOT-G11C8-20260901184500",
            ],
            "consumed_preparation_ids": [
                ...
                "FINANCE-PAGE100-G11C7-PREPARATION-20260901171500",
                "FINANCE-PAGE100-G11C8-PREPARATION-20260901184500",
            ],
            "consumed_precheck_act_ids": [
                ...
                "FINANCE-PAGE100-PRECHECK-ACT-G11C7-20260901171500",
                "FINANCE-PAGE100-PRECHECK-ACT-G11C8-20260901184500",
            ],
            "consumed_live_act_ids": [
                ...
                "FINANCE-PAGE100-LIVE-ACT-G11C7-20260901171500",
                "FINANCE-PAGE100-LIVE-ACT-G11C8-20260901184500",
            ],
            "consumed_latch_event_ids": [
                ...
                "FINANCE-PAGE100-LATCH-G11C7-20260901171500",
                "FINANCE-PAGE100-LATCH-G11C8-20260901184500",
            ],
            "current_run_retry_authorized": False,
            "same_activation_reuse_authorized": False,
            "same_latch_reuse_authorized": False,
            "same_generation_reuse_authorized": False,
            "same_runtime_lock_reuse_authorized": False,
            "same_pilot_run_id_reuse_authorized": False,
            "same_precheck_act_id_reuse_authorized": False,
            "same_live_act_id_reuse_authorized": False,
        },
        "live_adapter_gate": {
