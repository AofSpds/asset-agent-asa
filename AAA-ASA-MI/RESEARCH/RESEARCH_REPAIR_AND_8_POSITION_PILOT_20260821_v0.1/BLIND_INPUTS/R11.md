...
R11 contributes a continuous, set-valued account of persistence that separates four questions often conflated:
...
Construct label-free paired cases with the same underlying path family but different presentation order, sampling density, and successor labels. R11 predicts:
