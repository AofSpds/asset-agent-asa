...
import finance_page100_g11c2_selector_successor as g11c2  # noqa: E402
...
def raw_ref() -> g11c2.SealedRawReference:
    return g11c2.SealedRawReference(
        key=(
            "raw/public-data-api/M3TOP3-FINANCE-STOCK-RIGHTS-v1/"
            "_pilot_generation/G11C2/20260901130250/page-5.json"
        ),
...
) -> g11c2.HashedSourceRow:
    return g11c2.HashedSourceRow(
        bas_dt=g11c2.SEED_BASE_DATE,
        page_no=page_no,
...
def seeded_state() -> g11c2.ProjectionState:
    return g11c2.ProjectionState(
        source_rows=40,
        eligible_rows=35,
        excluded_rows=5,
        missing_rows=0,
...
def safe_adapter_document() -> dict:
    path = MODULE_DIR / "finance_page100_g11c2_live_adapter.py"
    return {
        "ready": True,
        "path": g11c2.LIVE_ADAPTER_REPO_PATH,
        "sha256": g11c2.sha256_file(path),
        "git_blob": g11c2.git_blob_sha1_file(path),
        "factory_symbol": g11c2.LIVE_ADAPTER_FACTORY_SYMBOL,
        "interface_version": g11c2.LIVE_ADAPTER_INTERFACE_VERSION,
    }


def predecessor_ineligible_preparation_binding() -> dict:
    return {
        "preparation_commit": g11c2.PREDECESSOR_G11C1_PREPARATION_COMMIT,
        "preparation_tree": g11c2.PREDECESSOR_G11C1_PREPARATION_TREE,
        ...
        "terminal_receipt_path": g11c2.PREDECESSOR_G11C1_TERMINAL_RECEIPT_PATH,
        "terminal_receipt_sha256": g11c2.PREDECESSOR_G11C1_TERMINAL_RECEIPT_SHA256,
        "terminal_receipt_git_blob":
            g11c2.PREDECESSOR_G11C1_TERMINAL_RECEIPT_GIT_BLOB,
        "terminal_receipt_payload_sha256":
            g11c2.PREDECESSOR_G11C1_TERMINAL_RECEIPT_PAYLOAD_SHA256,
        "terminal_receipt_bytes": g11c2.PREDECESSOR_G11C1_TERMINAL_RECEIPT_BYTES,
    }
...
def consumed_g11c1_identity_lists() -> dict:
    return {
        ...
        for field_name, values in g11c2.PREDECESSOR_G11C1_IDENTITIES.items()
    }
...
def authority_document() -> dict:
    ...
    return {
        "artifact": g11c2.AUTHORITY_SCHEMA,
        "schema_version": 1,
        "generation_timestamp": g11c2.GENERATION_TIMESTAMP,
        "authority_commit": g11c2.AUTHORITY_COMMIT,
        "owner_authority_binding": {
            "commit": g11c2.OWNER_APPROVAL_COMMIT,
            ...
            "governing_forward_only_receipt_commit": g11c2.GOVERNED_CORRECTION_HEAD,
            "governing_forward_only_receipt_git_blob": g11c2.OWNER_DECISION_V1_1_GIT_BLOB,
            "governing_forward_only_receipt_sha256": g11c2.OWNER_DECISION_V1_1_SHA256,
        },
        "predecessor_ineligible_preparation_binding":
            predecessor_ineligible_preparation_binding(),
        "fresh_identity": {
            "generation_id": g11c2.GENERATION_ID,
            "runtime_lock_id": g11c2.RUNTIME_LOCK_ID,
            "pilot_run_id": g11c2.PILOT_RUN_ID,
            "precheck_act_id": g11c2.PRECHECK_ACT_ID,
            "live_act_id": g11c2.LIVE_ACT_ID,
            "latch_event_id": g11c2.LATCH_EVENT_ID,
            "owner_cap_spec_sha256": g11c2.OWNER_CAP_SPEC_SHA256,
            "execution_token_sha256": g11c2.EXECUTION_TOKEN_SHA256,
            "identity_reuse_authorized": False,
        },
        "owner_cap_spec": g11c2.expected_owner_cap_spec(),
        "owner_cap_spec_canonicalization": "UTF8_JSON_SORT_KEYS_COMPACT_TRAILING_LF",
        "owner_cap_spec_sha256": g11c2.OWNER_CAP_SPEC_SHA256,
        "execution_token_material": g11c2.expected_execution_token_material(),
        ...
        "sealed_s3_projection_binding": {
            ...
            "missing_rows": 0,
            "excluded_global_row_ordinals": [36, 37, 38, 39, 40],
            "sealed_eligible_projection_sha256": g11c2.SEALED_SEED_PROJECTION_SHA256,
            "selector_algorithm": g11c2.SELECTOR_ALGORITHM,
            "selector_custody_key_sha256": g11c2.TARGET_CUSTODY_SHA256,
        ...
        "exact_resume_anchor": {
            "g10_checkpoint_sha256": g11c2.PREDECESSOR_CHECKPOINT_SHA256,
            "resume_bas_dt": g11c2.SEED_BASE_DATE,
            "next_page": 5,
        ...
        "adapter_execution_order_binding": g11c2.expected_adapter_execution_order(),
        "live_pre_mutation_order": g11c2.expected_live_pre_mutation_order(),
        "entry_gate": {
            "live_adapter_gate": g11c2.LIVE_ADAPTER_GATE_READY,
            "live_session_policy_ascii_and_size_ceiling_verified": True,
        },
        "safe_executable_adapter": safe_adapter,
        "no_rerun": {
            "consumed_github_runs": list(g11c2.REQUIRED_NO_RERUN_RUNS),
            **consumed_g11c1_identity_lists(),
        },
        "claim_ceiling": {
...
def plan_document(seed_path: Path) -> dict:
    return {
        "artifact": g11c2.PLAN_SCHEMA,
        "schema_version": 1,
        "generation_timestamp": g11c2.GENERATION_TIMESTAMP,
        "authority_commit": g11c2.AUTHORITY_COMMIT,
        "generation_id": g11c2.GENERATION_ID,
        "authority": {"owner_authority_commit": g11c2.OWNER_APPROVAL_COMMIT},
        "predecessor_ineligible_preparation_binding":
            predecessor_ineligible_preparation_binding(),
        "identity": {
            "generation_id": g11c2.GENERATION_ID,
        ...
        "resume_and_seed_contract": {
            ...
            "checkpoint_seed_sha256": g11c2.sha256_file(seed_path),
            "checkpoint_seed_git_blob": g11c2.git_blob_sha1_file(seed_path),
            "predecessor_checkpoint_sha256": g11c2.PREDECESSOR_CHECKPOINT_SHA256,
            "start_bas_dt": g11c2.SEED_BASE_DATE,
            "start_page": 5,
        },
        "no_rerun": consumed_g11c1_identity_lists(),
        "budget_contract": {
        ...
        "ordered_phases": [
            ...
            },
            {
                ...
                "actions": g11c2.expected_live_seed_verification_actions(),
...
def seed_document() -> dict:
    return {
        ...
        "next_page": 5,
        "predecessor": {
            "checkpoint_sha256": g11c2.PREDECESSOR_CHECKPOINT_SHA256,
            "validated_raw_pages": [1, 2, 3, 4],
        },
        "projection": {
            "selector_algorithm": g11c2.SELECTOR_ALGORITHM,
            "selector_sha256": g11c2.TARGET_CUSTODY_SHA256,
            "eligible_projection_sha256": g11c2.SEALED_SEED_PROJECTION_SHA256,
            "source_rows": 40,
            "eligible_rows": 35,
            "excluded_rows": 5,
            "missing_rows": 0,
...
def test_exact_generation_selector_seed_and_budget_constants() -> None:
    assert g11c2.GENERATION_TIMESTAMP == "20260901130250"
    assert g11c2.OWNER_APPROVAL_COMMIT == "884e1fadebda480f4c38d172eab083cbdbf031b2"
    assert g11c2.AUTHORITY_COMMIT == "19a62491c5168ee4c5f8ece31eba7598f11ebbbc"
    assert g11c2.GOVERNED_CORRECTION_HEAD == "19a62491c5168ee4c5f8ece31eba7598f11ebbbc"
    assert g11c2.GOVERNED_CORRECTION_TREE == "572bf2ab23a7d761de8160e6828f8b074618391b"
    assert g11c2.ACTIVATION_BASE_HEAD_COMMIT == "c7efa70b02249fb70a1f076a585e17a5b45c90c0"
    assert g11c2.ACTIVATION_BASE_TREE == "39aad4f2412c48fc16425c7d929d7410545a1b59"
    assert g11c2.PREDECESSOR_G11C1_PREPARATION_COMMIT == (
        "0ccb62cd4c0ceaa0409a56b40a899d00f531ba09"
    )
    assert g11c2.PREDECESSOR_G11C1_PREPARATION_TREE == (
        "f35d2bdd68138d527bc8603472311c0ca032988e"
    )
    assert g11c2.OWNER_CAP_SPEC_SHA256 == (
        "edbe0966e7051bd49e0f0878875d149c0668193ba6c4602b9984fbcdc0567b3d"
    )
    assert g11c2.EXECUTION_TOKEN_SHA256 == (
        "c5190d38a867e7d80448e03b48d0ff98b1338d02ac70a1e8ca8481d7f49c6fc2"
    )
    assert g11c2.TARGET_CUSTODY_SHA256 == (
        "f3e7b94dbde722df47cc3bb1a5615068cea42dc1994a91ce92317f5d1fb8b3d6"
    )
    assert g11c2.SEALED_SEED_PROJECTION_SHA256 == (
        "8f6986c9a9839ad62fe856dd0c4d31b54ce1982373deffd1404671c4c9fbfd24"
    )
    assert (g11c2.INHERITED_G10_ACQUISITIONS, g11c2.G11_ACQUISITION_CEILING) == (4, 1696)
    assert (g11c2.INHERITED_G10_ATTEMPTS, g11c2.G11_ATTEMPT_CEILING) == (4, 1996)
    assert g11c2.FIRST_NEW_PAGE == 5
    assert 33272691259 in g11c2.REQUIRED_NO_RERUN_RUNS
    assert 33273146915 in g11c2.REQUIRED_NO_RERUN_RUNS
    assert 33465583987 in g11c2.REQUIRED_NO_RERUN_RUNS
    assert 33466306591 in g11c2.REQUIRED_NO_RERUN_RUNS
    assert "FINANCE-PAGE100-G11C1-20260901123521" in (
        g11c2.PREDECESSOR_G11C1_IDENTITIES["consumed_generation_ids"]
    )
    assert list(g11c2.LIVE_PRE_MUTATION_PHASES) == [
...
def test_hash_only_projection_is_deterministic_for_non_target_rows() -> None:
    ...
    first, result = g11c2.project_hashed_rows(rows)
    second, _ = g11c2.project_hashed_rows(rows)
...
def test_only_sealed_seed_ordinals_36_through_40_can_be_excluded() -> None:
    state = g11c2.ProjectionState(source_rows=35, eligible_rows=35)
    result_state, result = g11c2.project_hashed_rows(
        [row(36, g11c2.TARGET_CUSTODY_SHA256, None, page_no=4, page_item_ordinal=6)],
        state,
        selector_policy=g11c2.SEED_SELECTOR_POLICY,
    )
    assert result.excluded_global_row_ordinals == (36,)
    assert result_state.excluded_rows == 1
    assert g11c2.TARGET_CUSTODY_SHA256 not in result_state.identity_map

    with raises(g11c2.GateError, match="SEALED_SELECTOR_SCOPE_VIOLATION"):
        g11c2.project_hashed_rows(
            [row(1, g11c2.TARGET_CUSTODY_SHA256, None, page_no=1)],
            selector_policy=g11c2.SEED_SELECTOR_POLICY,
        )
...
def test_future_selector_match_requires_raw_custody_then_stops_pending_owner() -> None:
    ...
    with raises(g11c2.FutureSelectorObservationError) as captured:
        g11c2.project_hashed_rows(
            [row(41, g11c2.TARGET_CUSTODY_SHA256, h("changed identity"))],
            original,
            raw_ref=raw_ref(),
            require_sealed_raw=True,
            selector_policy=g11c2.FUTURE_SELECTOR_POLICY,
        )
...
def test_future_selector_cannot_be_observed_before_raw_seal() -> None:
    with raises(g11c2.GateError, match="RAW_NOT_SEALED"):
        g11c2.project_hashed_rows(
            [row(41, g11c2.TARGET_CUSTODY_SHA256, None)],
            seeded_state(),
            require_sealed_raw=True,
        )
...
def test_non_target_conflict_and_missing_fields_fail_transactionally_after_raw_seal() -> None:
    original = seeded_state()
    with raises(g11c2.NonTargetIdentityConflictError):
        g11c2.project_hashed_rows(
    ...
    with raises(g11c2.MissingCustodyError):
        g11c2.project_hashed_rows(
    ...
    with raises(g11c2.MissingIdentityError):
        g11c2.project_hashed_rows(
...
def test_budget_exact_boundaries_and_per_page_attempt_gate() -> None:
    last = g11c2.BudgetState(g11_acquisitions=1695, g11_attempts=1995)
    ...
    with raises(g11c2.GateError, match="ACQUISITION_CEILING"):
        terminal.reserve_attempt(new_unique_acquisition=True, page_attempt=1)
    with raises(g11c2.GateError, match="ATTEMPTS_PER_PAGE_CEILING"):
        g11c2.BudgetState().reserve_attempt(new_unique_acquisition=True, page_attempt=3)


def test_append_only_namespace_guard_rejects_historical_keys() -> None:
    g11c2.validate_g11_object_key(
        "raw/public-data-api/source/G11C2/20260901130250/page-5.json"
    )
    with raises(g11c2.GateError, match="HISTORICAL_NAMESPACE_WRITE_FORBIDDEN"):
        g11c2.validate_g11_object_key(
            "raw/public-data-api/source/G10/G11C2/20260901130250/page-5.json"
        )


def test_sealed_adapter_dynamic_import_registers_dataclass_module_and_factory() -> None:
    adapter_path = MODULE_DIR / "finance_page100_g11c2_live_adapter.py"
    factory = g11c2.load_sealed_live_adapter_factory(
        adapter_path, g11c2.sha256_file(adapter_path)
    )
    assert callable(factory)
    assert factory.__name__ == g11c2.LIVE_ADAPTER_FACTORY_SYMBOL
...
def test_runtime_live_head_markers_resolve_only_from_exact_github_environment() -> None:
    ...
    activation = {
        "activation_binding": {
            "live_activation_commit": g11c2.LIVE_HEAD_MARKER,
            "live_activation_tree": g11c2.LIVE_TREE_MARKER,
            "expected_branch_head_at_dispatch": g11c2.LIVE_HEAD_MARKER,
        }
    }
    observed = g11c2.validate_runtime_live_head_binding(
        activation,
        environment={
            "G11C2_LIVE_HEAD_SHA": head,
            "G11C2_LIVE_HEAD_TREE": tree,
            "GITHUB_SHA": head,
    ...
    with raises(g11c2.GateError, match="live activation commit marker"):
        g11c2.validate_runtime_live_head_binding(
            embedded,
            environment={
                "G11C2_LIVE_HEAD_SHA": head,
                "G11C2_LIVE_HEAD_TREE": tree,
    ...
    with raises(g11c2.GateError, match="GITHUB_SHA"):
        g11c2.validate_runtime_live_head_binding(
            activation,
            environment={
                "G11C2_LIVE_HEAD_SHA": head,
...
def test_live_result_binds_actual_execution_and_single_terminal_put() -> None:
    ...
    def object_binding(name: str, *, key: str | None = None) -> dict:
        return {
            "key": key or f"raw/public-data-api/source/G11C2/{g11c2.GENERATION_TIMESTAMP}/{name}.json",
    ...
    effects = dict(g11c2.LIVE_ZERO_EFFECTS)
    effects.update({
    ...
    result = {
        ...
        "execution_claim_binding": object_binding("claim", key=g11c2.EXECUTION_CLAIM_KEY),
        "checkpoint_binding": object_binding("checkpoint", key=g11c2.G11_CHECKPOINT_KEY),
        "terminal_receipt_binding": {
            "key": g11c2.G11_TERMINAL_RECEIPT_KEY,
            "attempted": True,
            "put_attempts": 1,
            "confirmed": True,
            "object": object_binding("terminal", key=g11c2.G11_TERMINAL_RECEIPT_KEY),
        },
    }
    code, normalized = g11c2._normalize_and_validate_live_result(
    ...
    with raises(g11c2.GateError, match="terminal receipt attempt/write"):
        g11c2._normalize_and_validate_live_result(
...
def test_seed_summary_reuses_sealed_receipts_and_defers_raw_recheck_to_live() -> None:
    assert g11c2.validate_seed_document(seed_document()) == "SEALED_RECEIPT_REUSE"


def test_plan_must_bind_exact_current_seed_sha_and_blob() -> None:
    with tempfile.TemporaryDirectory() as temporary_directory:
        seed_path = Path(temporary_directory) / g11c2.SEED_FILENAME
        write_json(seed_path, seed_document())
        plan = plan_document(seed_path)
        g11c2.validate_plan_seed_material_binding(plan, seed_path)
        write_json(seed_path, {**seed_document(), "state": "mutated-after-plan-binding"})
        with raises(g11c2.GateError, match="checkpoint_seed_sha256"):
            g11c2.validate_plan_seed_material_binding(plan, seed_path)
...
def test_live_session_policy_ascii_and_2048_character_limit() -> None:
    with tempfile.TemporaryDirectory() as temporary_directory:
        ...
        write_json(policy_path, g11c2.expected_live_session_policy())
        exact_length = g11c2.validate_live_session_policy_for_aws(policy_path)
        assert exact_length <= 2048

        original_ceiling = g11c2.AWS_INLINE_SESSION_POLICY_ASCII_CHARACTER_CEILING
        try:
            g11c2.AWS_INLINE_SESSION_POLICY_ASCII_CHARACTER_CEILING = exact_length - 1
            with raises(g11c2.GateError, match="LIVE_SESSION_POLICY_EXCEEDS"):
                g11c2.validate_live_session_policy_for_aws(policy_path)
        finally:
            g11c2.AWS_INLINE_SESSION_POLICY_ASCII_CHARACTER_CEILING = original_ceiling

        forbidden_version = g11c2.expected_live_session_policy()
        forbidden_version["Version"] = "2012-10-17"
        write_json(policy_path, forbidden_version)
        with raises(g11c2.GateError, match="VERSION_MUST_BE_OMITTED"):
            g11c2.validate_live_session_policy_for_aws(policy_path)
...
def test_bundle_hash_bindings_and_precheck_zero_effect_contract() -> None:
    with tempfile.TemporaryDirectory() as temporary_directory:
        ...
        authority_path = tmp_path / g11c2.AUTHORITY_FILENAME
        plan_path = tmp_path / g11c2.PLAN_FILENAME
        seed_path = tmp_path / g11c2.SEED_FILENAME
        manifest_path = tmp_path / g11c2.MANIFEST_FILENAME
        live_policy_path = tmp_path / "g11c2-live-policy.json"
        test_path = Path(__file__).resolve()
        runner_path = Path(g11c2.__file__).resolve()
        adapter_path = MODULE_DIR / "finance_page100_g11c2_live_adapter.py"

        write_json(authority_path, authority_document())
        write_json(seed_path, seed_document())
        write_json(plan_path, plan_document(seed_path))
        write_json(live_policy_path, g11c2.expected_live_session_policy())
        safe_adapter = safe_adapter_document()
        ...
        manifest = {
            "artifact": g11c2.MANIFEST_SCHEMA,
            "schema_version": 1,
            "generation_timestamp": g11c2.GENERATION_TIMESTAMP,
            "generation_id": g11c2.GENERATION_ID,
            "authority_commit": g11c2.AUTHORITY_COMMIT,
            ...
            "sealed_scope_summary": {
                "owner_cap_spec_sha256": g11c2.OWNER_CAP_SPEC_SHA256,
                "execution_token_sha256": g11c2.EXECUTION_TOKEN_SHA256,
                "fixed_quota_day_kst": g11c2.QUOTA_DAY_KST,
            },
            "adapter_execution_order_binding": g11c2.expected_adapter_execution_order(),
            "files": {
        ...
        assert result["governed_correction_head"] == g11c2.GOVERNED_CORRECTION_HEAD
        assert result["live_adapter_gate"] == g11c2.LIVE_ADAPTER_GATE_READY
        assert all(value == 0 for value in g11c2.ZERO_EFFECTS.values())

        blocked = dict(manifest)
        blocked["live_adapter_gate"] = g11c2.LIVE_ADAPTER_GATE_BLOCKED
        blocked_manifest = tmp_path / ("blocked-" + g11c2.MANIFEST_FILENAME)
        write_json(blocked_manifest, blocked)
        with raises(g11c2.GateError, match="manifest.live_adapter_gate"):
            g11c2.validate_manifest_document(
                blocked,
                authority_path=authority_path,
                plan_path=plan_path,
                seed_path=seed_path,
...
def test_unsealed_owner_decision_v11_binding_fails_closed() -> None:
    ...
    with raises(g11c2.GateError, match="UNSEALED_AUTHORITY_PLACEHOLDER"):
        g11c2.validate_authority_document(authority)
