...
import finance_page100_g11_selector_successor as g11  # noqa: E402
...
def raw_ref() -> g11.SealedRawReference:
    return g11.SealedRawReference(
        key=(
            "raw/public-data-api/M3TOP3-FINANCE-STOCK-RIGHTS-v1/"
            "_pilot_generation/G11/20260901110618/page-5.json"
        ),
...
def row(
    ...
    *,
    ...
    return g11.HashedSourceRow(
        bas_dt=g11.SEED_BASE_DATE,
        page_no=page_no,
...
def seeded_state() -> g11.ProjectionState:
    return g11.ProjectionState(
        source_rows=40,
        eligible_rows=35,
        excluded_rows=5,
        missing_rows=0,
...
def safe_adapter_document() -> dict:
    path = MODULE_DIR / "finance_page100_g11_live_adapter.py"
    return {
        "ready": True,
        "path": g11.LIVE_ADAPTER_REPO_PATH,
        "sha256": g11.sha256_file(path),
        "git_blob": g11.git_blob_sha1_file(path),
        "factory_symbol": g11.LIVE_ADAPTER_FACTORY_SYMBOL,
        "interface_version": g11.LIVE_ADAPTER_INTERFACE_VERSION,
    }
...
def authority_document() -> dict:
    ...
    return {
        "artifact": g11.AUTHORITY_SCHEMA,
        "schema_version": 1,
        "generation_timestamp": g11.GENERATION_TIMESTAMP,
        "authority_commit": g11.AUTHORITY_COMMIT,
        "owner_authority_binding": {
            "commit": g11.OWNER_APPROVAL_COMMIT,
            ...
            "governing_forward_only_receipt_commit": g11.GOVERNED_CORRECTION_HEAD,
            "governing_forward_only_receipt_git_blob": g11.OWNER_DECISION_V1_1_GIT_BLOB,
            "governing_forward_only_receipt_sha256": g11.OWNER_DECISION_V1_1_SHA256,
        },
        "fresh_identity": {
            "generation_id": g11.GENERATION_ID,
            "runtime_lock_id": g11.RUNTIME_LOCK_ID,
            "pilot_run_id": g11.PILOT_RUN_ID,
            "precheck_act_id": g11.PRECHECK_ACT_ID,
            "live_act_id": g11.LIVE_ACT_ID,
            "latch_event_id": g11.LATCH_EVENT_ID,
            "owner_cap_spec_sha256": g11.OWNER_CAP_SPEC_SHA256,
            "execution_token_sha256": g11.EXECUTION_TOKEN_SHA256,
            "identity_reuse_authorized": False,
        },
        "owner_cap_spec": g11.expected_owner_cap_spec(),
        "owner_cap_spec_canonicalization": "UTF8_JSON_SORT_KEYS_COMPACT_TRAILING_LF",
        "owner_cap_spec_sha256": g11.OWNER_CAP_SPEC_SHA256,
        "execution_token_material": g11.expected_execution_token_material(),
        ...
        "sealed_s3_projection_binding": {
            ...
            "missing_rows": 0,
            "excluded_global_row_ordinals": [36, 37, 38, 39, 40],
            "sealed_eligible_projection_sha256": g11.SEALED_SEED_PROJECTION_SHA256,
            "selector_algorithm": g11.SELECTOR_ALGORITHM,
            "selector_custody_key_sha256": g11.TARGET_CUSTODY_SHA256,
        ...
        "exact_resume_anchor": {
            "g10_checkpoint_sha256": g11.PREDECESSOR_CHECKPOINT_SHA256,
            "resume_bas_dt": g11.SEED_BASE_DATE,
            "next_page": 5,
        ...
        "adapter_execution_order_binding": g11.expected_adapter_execution_order(),
        "live_pre_mutation_order": g11.expected_live_pre_mutation_order(),
        "entry_gate": {"live_adapter_gate": g11.LIVE_ADAPTER_GATE_READY},
        "safe_executable_adapter": safe_adapter,
        "no_rerun": {
            "consumed_github_runs": list(g11.REQUIRED_NO_RERUN_RUNS),
        },
        "claim_ceiling": {
...
def plan_document() -> dict:
    return {
        "artifact": g11.PLAN_SCHEMA,
        "schema_version": 1,
        "generation_timestamp": g11.GENERATION_TIMESTAMP,
        "authority_commit": g11.AUTHORITY_COMMIT,
        "generation_id": g11.GENERATION_ID,
        "authority": {"owner_authority_commit": g11.OWNER_APPROVAL_COMMIT},
        "identity": {
            "generation_id": g11.GENERATION_ID,
            "runtime_lock_id": g11.RUNTIME_LOCK_ID,
            "pilot_run_id": g11.PILOT_RUN_ID,
        ...
        "resume_and_seed_contract": {
            "predecessor_checkpoint_sha256": g11.PREDECESSOR_CHECKPOINT_SHA256,
            "start_bas_dt": g11.SEED_BASE_DATE,
            "start_page": 5,
        },
        "budget_contract": {
        ...
        "ordered_phases": [
            ...
            },
            {
                ...
                "actions": g11.expected_live_seed_verification_actions(),
...
def seed_document() -> dict:
    return {
        ...
        "next_page": 5,
        "predecessor": {
            "checkpoint_sha256": g11.PREDECESSOR_CHECKPOINT_SHA256,
            "validated_raw_pages": [1, 2, 3, 4],
        },
        "projection": {
            "selector_algorithm": g11.SELECTOR_ALGORITHM,
            "selector_sha256": g11.TARGET_CUSTODY_SHA256,
            "eligible_projection_sha256": g11.SEALED_SEED_PROJECTION_SHA256,
            "source_rows": 40,
            "eligible_rows": 35,
            "excluded_rows": 5,
            "missing_rows": 0,
...
def test_exact_generation_selector_seed_and_budget_constants() -> None:
    assert g11.GENERATION_TIMESTAMP == "20260901110618"
    assert g11.OWNER_APPROVAL_COMMIT == "884e1fadebda480f4c38d172eab083cbdbf031b2"
    assert g11.AUTHORITY_COMMIT == "19a62491c5168ee4c5f8ece31eba7598f11ebbbc"
    assert g11.GOVERNED_CORRECTION_HEAD == "19a62491c5168ee4c5f8ece31eba7598f11ebbbc"
    assert g11.GOVERNED_CORRECTION_TREE == "572bf2ab23a7d761de8160e6828f8b074618391b"
    assert g11.TARGET_CUSTODY_SHA256 == (
        "f3e7b94dbde722df47cc3bb1a5615068cea42dc1994a91ce92317f5d1fb8b3d6"
    )
    assert g11.SEALED_SEED_PROJECTION_SHA256 == (
        "8f6986c9a9839ad62fe856dd0c4d31b54ce1982373deffd1404671c4c9fbfd24"
    )
    assert (g11.INHERITED_G10_ACQUISITIONS, g11.G11_ACQUISITION_CEILING) == (4, 1696)
    assert (g11.INHERITED_G10_ATTEMPTS, g11.G11_ATTEMPT_CEILING) == (4, 1996)
    assert g11.FIRST_NEW_PAGE == 5
    assert 33272691259 in g11.REQUIRED_NO_RERUN_RUNS
    assert 33273146915 in g11.REQUIRED_NO_RERUN_RUNS
    assert list(g11.LIVE_PRE_MUTATION_PHASES) == [
...
def test_hash_only_projection_is_deterministic_for_non_target_rows() -> None:
    ...
    first, result = g11.project_hashed_rows(rows)
    second, _ = g11.project_hashed_rows(rows)
...
def test_only_sealed_seed_ordinals_36_through_40_can_be_excluded() -> None:
    state = g11.ProjectionState(source_rows=35, eligible_rows=35)
    result_state, result = g11.project_hashed_rows(
        [row(36, g11.TARGET_CUSTODY_SHA256, None, page_no=4, page_item_ordinal=6)],
        state,
        selector_policy=g11.SEED_SELECTOR_POLICY,
    )
    assert result.excluded_global_row_ordinals == (36,)
    assert result_state.excluded_rows == 1
    assert g11.TARGET_CUSTODY_SHA256 not in result_state.identity_map

    with raises(g11.GateError, match="SEALED_SELECTOR_SCOPE_VIOLATION"):
        g11.project_hashed_rows(
            [row(1, g11.TARGET_CUSTODY_SHA256, None, page_no=1)],
            selector_policy=g11.SEED_SELECTOR_POLICY,
        )
...
def test_future_selector_match_requires_raw_custody_then_stops_pending_owner() -> None:
    ...
    with raises(g11.FutureSelectorObservationError) as captured:
        g11.project_hashed_rows(
            [row(41, g11.TARGET_CUSTODY_SHA256, h("changed identity"))],
            original,
            raw_ref=raw_ref(),
            require_sealed_raw=True,
            selector_policy=g11.FUTURE_SELECTOR_POLICY,
        )
...
def test_future_selector_cannot_be_observed_before_raw_seal() -> None:
    with raises(g11.GateError, match="RAW_NOT_SEALED"):
        g11.project_hashed_rows(
            [row(41, g11.TARGET_CUSTODY_SHA256, None)],
            seeded_state(),
            require_sealed_raw=True,
        )
...
def test_non_target_conflict_and_missing_fields_fail_transactionally_after_raw_seal() -> None:
    original = seeded_state()
    with raises(g11.NonTargetIdentityConflictError):
        g11.project_hashed_rows(
    ...
    with raises(g11.MissingCustodyError):
        g11.project_hashed_rows(
    ...
    with raises(g11.MissingIdentityError):
        g11.project_hashed_rows(
...
def test_budget_exact_boundaries_and_per_page_attempt_gate() -> None:
    last = g11.BudgetState(g11_acquisitions=1695, g11_attempts=1995)
    ...
    with raises(g11.GateError, match="ACQUISITION_CEILING"):
        terminal.reserve_attempt(new_unique_acquisition=True, page_attempt=1)
    with raises(g11.GateError, match="ATTEMPTS_PER_PAGE_CEILING"):
        g11.BudgetState().reserve_attempt(new_unique_acquisition=True, page_attempt=3)


def test_append_only_namespace_guard_rejects_historical_keys() -> None:
    g11.validate_g11_object_key(
        "raw/public-data-api/source/G11/20260901110618/page-5.json"
    )
    with raises(g11.GateError, match="HISTORICAL_NAMESPACE_WRITE_FORBIDDEN"):
        g11.validate_g11_object_key(
            "raw/public-data-api/source/G10/G11/20260901110618/page-5.json"
        )


def test_sealed_adapter_dynamic_import_registers_dataclass_module_and_factory() -> None:
    adapter_path = MODULE_DIR / "finance_page100_g11_live_adapter.py"
    factory = g11.load_sealed_live_adapter_factory(
        adapter_path, g11.sha256_file(adapter_path)
    )
    assert callable(factory)
    assert factory.__name__ == g11.LIVE_ADAPTER_FACTORY_SYMBOL
...
def test_runtime_live_head_markers_resolve_only_from_exact_github_environment() -> None:
    ...
    activation = {
        "activation_binding": {
            "live_activation_commit": g11.LIVE_HEAD_MARKER,
            "live_activation_tree": g11.LIVE_TREE_MARKER,
            "expected_branch_head_at_dispatch": g11.LIVE_HEAD_MARKER,
        }
    }
    observed = g11.validate_runtime_live_head_binding(
        activation,
        environment={
            "G11_LIVE_HEAD_SHA": head,
            "G11_LIVE_HEAD_TREE": tree,
            "GITHUB_SHA": head,
    ...
    with raises(g11.GateError, match="live activation commit marker"):
        g11.validate_runtime_live_head_binding(
            embedded,
            environment={
                "G11_LIVE_HEAD_SHA": head,
                "G11_LIVE_HEAD_TREE": tree,
    ...
    with raises(g11.GateError, match="GITHUB_SHA"):
        g11.validate_runtime_live_head_binding(
            activation,
            environment={
                "G11_LIVE_HEAD_SHA": head,
...
def test_live_result_binds_actual_execution_and_single_terminal_put() -> None:
    ...
    def object_binding(name: str, *, key: str | None = None) -> dict:
        return {
            "key": key or f"raw/public-data-api/source/G11/{g11.GENERATION_TIMESTAMP}/{name}.json",
    ...
    effects = dict(g11.LIVE_ZERO_EFFECTS)
    effects.update({
    ...
    result = {
        "schema": "M3TOP3_FINANCE_CA_PAGE100_G11_LIVE_ENTRY_RESULT_v1.0",
        "verdict": "PASS",
        "entry_gate": "LIVE_ENTERED_ONCE",
        "execution_binding": execution,
        "effects": effects,
        "effect_reconciliation": {"complete": True, "ambiguous_side_effects": False},
        "execution_claim_binding": object_binding("claim", key=g11.EXECUTION_CLAIM_KEY),
        "checkpoint_binding": object_binding("checkpoint", key=g11.G11_CHECKPOINT_KEY),
        "terminal_receipt_binding": {
            "key": g11.G11_TERMINAL_RECEIPT_KEY,
            "attempted": True,
            "put_attempts": 1,
            "confirmed": True,
            "object": object_binding("terminal", key=g11.G11_TERMINAL_RECEIPT_KEY),
        },
    }
    code, normalized = g11._normalize_and_validate_live_result(
    ...
    with raises(g11.GateError, match="terminal receipt attempt/write"):
        g11._normalize_and_validate_live_result(
...
def test_seed_summary_reuses_sealed_receipts_and_defers_raw_recheck_to_live() -> None:
    assert g11.validate_seed_document(seed_document()) == "SEALED_RECEIPT_REUSE"


def test_bundle_hash_bindings_and_precheck_zero_effect_contract() -> None:
    with tempfile.TemporaryDirectory() as temporary_directory:
        tmp_path = Path(temporary_directory)
        authority_path = tmp_path / g11.AUTHORITY_FILENAME
        plan_path = tmp_path / g11.PLAN_FILENAME
        seed_path = tmp_path / g11.SEED_FILENAME
        manifest_path = tmp_path / g11.MANIFEST_FILENAME
        test_path = Path(__file__).resolve()
        runner_path = Path(g11.__file__).resolve()
        adapter_path = MODULE_DIR / "finance_page100_g11_live_adapter.py"
        ...
        manifest = {
            ...
            "sealed_scope_summary": {
                "owner_cap_spec_sha256": g11.OWNER_CAP_SPEC_SHA256,
                "execution_token_sha256": g11.EXECUTION_TOKEN_SHA256,
                "fixed_quota_day_kst": g11.QUOTA_DAY_KST,
            },
            "adapter_execution_order_binding": g11.expected_adapter_execution_order(),
            "files": {
            ...
            "live_adapter_gate": g11.LIVE_ADAPTER_GATE_READY,
            "live_adapter": {
                "executable": True,
                "sealed": True,
                "ready": True,
        ...
        assert result["governed_correction_head"] == g11.GOVERNED_CORRECTION_HEAD
        assert result["live_adapter_gate"] == g11.LIVE_ADAPTER_GATE_READY
        assert all(value == 0 for value in g11.ZERO_EFFECTS.values())

        blocked = dict(manifest)
        blocked["live_adapter_gate"] = g11.LIVE_ADAPTER_GATE_BLOCKED
        blocked_manifest = tmp_path / ("blocked-" + g11.MANIFEST_FILENAME)
        write_json(blocked_manifest, blocked)
        with raises(g11.GateError, match="manifest.live_adapter_gate"):
            g11.validate_manifest_document(
                blocked,
                authority_path=authority_path,
                plan_path=plan_path,
                seed_path=seed_path,
...
def test_unsealed_owner_decision_v11_binding_fails_closed() -> None:
    ...
    with raises(g11.GateError, match="UNSEALED_AUTHORITY_PLACEHOLDER"):
        g11.validate_authority_document(authority)
