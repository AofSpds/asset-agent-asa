...
import finance_page100_g11c4_selector_successor as g11c4  # noqa: E402
...
def raw_ref() -> g11c4.SealedRawReference:
    return g11c4.SealedRawReference(
        key=(
            "raw/public-data-api/M3TOP3-FINANCE-STOCK-RIGHTS-v1/"
            "_pilot_generation/G11C4/20260901143300/page-5.json"
        ),
...
) -> g11c4.HashedSourceRow:
    return g11c4.HashedSourceRow(
        bas_dt=g11c4.SEED_BASE_DATE,
        page_no=page_no,
...
def seeded_state() -> g11c4.ProjectionState:
    return g11c4.ProjectionState(
        source_rows=40,
        eligible_rows=35,
        excluded_rows=5,
        missing_rows=0,
...
def safe_adapter_document() -> dict:
    path = MODULE_DIR / "finance_page100_g11c4_live_adapter.py"
    return {
        "ready": True,
        "path": g11c4.LIVE_ADAPTER_REPO_PATH,
        "sha256": g11c4.sha256_file(path),
        "git_blob": g11c4.git_blob_sha1_file(path),
        "factory_symbol": g11c4.LIVE_ADAPTER_FACTORY_SYMBOL,
        "interface_version": g11c4.LIVE_ADAPTER_INTERFACE_VERSION,
    }


def predecessor_ineligible_preparation_binding() -> dict:
    return {
        "preparation_commit": g11c4.PREDECESSOR_G11C1_PREPARATION_COMMIT,
        "preparation_tree": g11c4.PREDECESSOR_G11C1_PREPARATION_TREE,
        ...
        "terminal_receipt_path": g11c4.PREDECESSOR_G11C1_TERMINAL_RECEIPT_PATH,
        "terminal_receipt_sha256": g11c4.PREDECESSOR_G11C1_TERMINAL_RECEIPT_SHA256,
        "terminal_receipt_git_blob":
            g11c4.PREDECESSOR_G11C1_TERMINAL_RECEIPT_GIT_BLOB,
        "terminal_receipt_payload_sha256":
            g11c4.PREDECESSOR_G11C1_TERMINAL_RECEIPT_PAYLOAD_SHA256,
        "terminal_receipt_bytes": g11c4.PREDECESSOR_G11C1_TERMINAL_RECEIPT_BYTES,
    }
...
def consumed_g11c1_identity_lists() -> dict:
    return {
        ...
        for field_name, values in g11c4.PREDECESSOR_G11C1_IDENTITIES.items()
    }


def predecessor_invalidated_g11c2_binding() -> dict:
    return g11c4.predecessor_invalidated_g11c2_binding()


def predecessor_terminal_g11c3_binding() -> dict:
    return g11c4.predecessor_terminal_g11c3_binding()


def consumed_predecessor_lineage() -> dict:
    result = consumed_g11c1_identity_lists()
    for field_name, values in g11c4.PREDECESSOR_G11C2_IDENTITIES.items():
        result.setdefault(field_name, []).extend(values)
    result.update({
        "g11c2_precheck_run_id": g11c4.PREDECESSOR_G11C2_PRECHECK_RUN_ID,
        "g11c2_precheck_run_attempt": g11c4.PREDECESSOR_G11C2_PRECHECK_RUN_ATTEMPT,
    ...
    for field_name, values in g11c4.PREDECESSOR_G11C3_IDENTITIES.items():
        result.setdefault(field_name, []).extend(values)
    result.update({
...
def authority_document() -> dict:
    ...
    return {
        "artifact": g11c4.AUTHORITY_SCHEMA,
        "schema_version": 1,
        "generation_timestamp": g11c4.GENERATION_TIMESTAMP,
        "authority_commit": g11c4.AUTHORITY_COMMIT,
        "owner_authority_binding": {
            "commit": g11c4.OWNER_APPROVAL_COMMIT,
            ...
            "governing_forward_only_receipt_commit": g11c4.GOVERNED_CORRECTION_HEAD,
            "governing_forward_only_receipt_git_blob": g11c4.OWNER_DECISION_V1_1_GIT_BLOB,
            "governing_forward_only_receipt_sha256": g11c4.OWNER_DECISION_V1_1_SHA256,
        },
        ...
        "predecessor_terminal_g11c3_binding":
            predecessor_terminal_g11c3_binding(),
        "fresh_identity": {
            "generation_id": g11c4.GENERATION_ID,
            "runtime_lock_id": g11c4.RUNTIME_LOCK_ID,
            "pilot_run_id": g11c4.PILOT_RUN_ID,
            "precheck_act_id": g11c4.PRECHECK_ACT_ID,
            "live_act_id": g11c4.LIVE_ACT_ID,
            "latch_event_id": g11c4.LATCH_EVENT_ID,
            "owner_cap_spec_sha256": g11c4.OWNER_CAP_SPEC_SHA256,
            "execution_token_sha256": g11c4.EXECUTION_TOKEN_SHA256,
            "identity_reuse_authorized": False,
        },
        "owner_cap_spec": g11c4.expected_owner_cap_spec(),
        "owner_cap_spec_canonicalization": "UTF8_JSON_SORT_KEYS_COMPACT_TRAILING_LF",
        "owner_cap_spec_sha256": g11c4.OWNER_CAP_SPEC_SHA256,
        "execution_token_material": g11c4.expected_execution_token_material(),
        ...
        "sealed_s3_projection_binding": {
            ...
            "missing_rows": 0,
            "excluded_global_row_ordinals": [36, 37, 38, 39, 40],
            "sealed_eligible_projection_sha256": g11c4.SEALED_SEED_PROJECTION_SHA256,
            "selector_algorithm": g11c4.SELECTOR_ALGORITHM,
            "selector_custody_key_sha256": g11c4.TARGET_CUSTODY_SHA256,
        ...
        "exact_resume_anchor": {
            "g10_checkpoint_sha256": g11c4.PREDECESSOR_CHECKPOINT_SHA256,
            "resume_bas_dt": g11c4.SEED_BASE_DATE,
            "next_page": 5,
        ...
        "adapter_execution_order_binding": g11c4.expected_adapter_execution_order(),
        "live_pre_mutation_order": g11c4.expected_live_pre_mutation_order(),
        "entry_gate": {
            "live_adapter_gate": g11c4.LIVE_ADAPTER_GATE_READY,
            "live_session_policy_ascii_and_size_ceiling_verified": True,
        },
        "safe_executable_adapter": safe_adapter,
        "custody_boundary": {
            "g11_raw_prefix": g11c4.G11_RAW_PREFIX,
            "g11_control_prefix": g11c4.G11_CONTROL_PREFIX,
            "execution_claim_key": g11c4.EXECUTION_CLAIM_KEY,
            "predecessor_objects_immutable": True,
        },
        "no_rerun": {
            "consumed_github_runs": list(g11c4.REQUIRED_NO_RERUN_RUNS),
...
def plan_document(seed_path: Path) -> dict:
    return {
        "artifact": g11c4.PLAN_SCHEMA,
        "schema_version": 1,
        "generation_timestamp": g11c4.GENERATION_TIMESTAMP,
        "authority_commit": g11c4.AUTHORITY_COMMIT,
        "generation_id": g11c4.GENERATION_ID,
        "authority": {"owner_authority_commit": g11c4.OWNER_APPROVAL_COMMIT},
        "predecessor_ineligible_preparation_binding":
            predecessor_ineligible_preparation_binding(),
        "predecessor_invalidated_g11c2_binding":
            predecessor_invalidated_g11c2_binding(),
        ...
        "resume_and_seed_contract": {
            ...
            "checkpoint_seed_sha256": g11c4.sha256_file(seed_path),
            "checkpoint_seed_git_blob": g11c4.git_blob_sha1_file(seed_path),
            "predecessor_checkpoint_sha256": g11c4.PREDECESSOR_CHECKPOINT_SHA256,
            "start_bas_dt": g11c4.SEED_BASE_DATE,
            "start_page": 5,
        },
        ...
        "ordered_phases": [
            ...
            },
            {
                ...
                "actions": g11c4.expected_live_seed_verification_actions(),
...
def seed_document() -> dict:
    return {
        ...
        "next_page": 5,
        "predecessor": {
            "checkpoint_sha256": g11c4.PREDECESSOR_CHECKPOINT_SHA256,
            "validated_raw_pages": [1, 2, 3, 4],
        },
        "projection": {
            "selector_algorithm": g11c4.SELECTOR_ALGORITHM,
            "selector_sha256": g11c4.TARGET_CUSTODY_SHA256,
            "eligible_projection_sha256": g11c4.SEALED_SEED_PROJECTION_SHA256,
            "source_rows": 40,
            "eligible_rows": 35,
            "excluded_rows": 5,
            "missing_rows": 0,
...
def test_exact_generation_selector_seed_and_budget_constants() -> None:
    assert g11c4.GENERATION_TIMESTAMP == "20260901143300"
    assert g11c4.OWNER_APPROVAL_COMMIT == "884e1fadebda480f4c38d172eab083cbdbf031b2"
    assert g11c4.AUTHORITY_COMMIT == "19a62491c5168ee4c5f8ece31eba7598f11ebbbc"
    assert g11c4.GOVERNED_CORRECTION_HEAD == "19a62491c5168ee4c5f8ece31eba7598f11ebbbc"
    assert g11c4.GOVERNED_CORRECTION_TREE == "572bf2ab23a7d761de8160e6828f8b074618391b"
    assert g11c4.ACTIVATION_BASE_HEAD_COMMIT == "8b6cfcb03904e58c5ffabb3ff3c10cb5d6850444"
    assert g11c4.ACTIVATION_BASE_TREE == "27af43d2d49476ce552e5c59010bac93c890c194"
    assert g11c4.PREDECESSOR_G11C1_PREPARATION_COMMIT == (
        "0ccb62cd4c0ceaa0409a56b40a899d00f531ba09"
    )
    assert g11c4.PREDECESSOR_G11C1_PREPARATION_TREE == (
        "f35d2bdd68138d527bc8603472311c0ca032988e"
    )
    assert g11c4.OWNER_CAP_SPEC_SHA256 == "657516c66a6fbce60441d0f33b61c95ac6dd7305fc9148603a6f94d32962ea9e"
    assert g11c4.EXECUTION_TOKEN_SHA256 == "f8076bd24d6b85750be1756792367bbcbae078f22fe1ce7cc84be225a2708abe"
    assert g11c4.TARGET_CUSTODY_SHA256 == (
        "f3e7b94dbde722df47cc3bb1a5615068cea42dc1994a91ce92317f5d1fb8b3d6"
    )
    assert g11c4.SEALED_SEED_PROJECTION_SHA256 == (
        "8f6986c9a9839ad62fe856dd0c4d31b54ce1982373deffd1404671c4c9fbfd24"
    )
    assert (g11c4.INHERITED_G10_ACQUISITIONS, g11c4.G11_ACQUISITION_CEILING) == (4, 1696)
    assert (g11c4.INHERITED_G10_ATTEMPTS, g11c4.G11_ATTEMPT_CEILING) == (4, 1996)
    assert g11c4.FIRST_NEW_PAGE == 5
    assert 33272691259 in g11c4.REQUIRED_NO_RERUN_RUNS
    assert 33273146915 in g11c4.REQUIRED_NO_RERUN_RUNS
    assert 33465583987 in g11c4.REQUIRED_NO_RERUN_RUNS
    assert 33466306591 in g11c4.REQUIRED_NO_RERUN_RUNS
    assert 33469887723 in g11c4.REQUIRED_NO_RERUN_RUNS
    assert 33472741288 in g11c4.REQUIRED_NO_RERUN_RUNS
    assert 33473465774 in g11c4.REQUIRED_NO_RERUN_RUNS
    assert "FINANCE-PAGE100-G11C1-20260901123521" in (
        g11c4.PREDECESSOR_G11C1_IDENTITIES["consumed_generation_ids"]
    )
    assert "FINANCE-PAGE100-G11C2-20260901130250" in (
        g11c4.PREDECESSOR_G11C2_IDENTITIES["consumed_generation_ids"]
    )
    ...
    assert list(g11c4.LIVE_PRE_MUTATION_PHASES) == [
...
def test_hash_only_projection_is_deterministic_for_non_target_rows() -> None:
    ...
    first, result = g11c4.project_hashed_rows(rows)
    second, _ = g11c4.project_hashed_rows(rows)
...
def test_only_sealed_seed_ordinals_36_through_40_can_be_excluded() -> None:
    state = g11c4.ProjectionState(source_rows=35, eligible_rows=35)
    result_state, result = g11c4.project_hashed_rows(
        [row(36, g11c4.TARGET_CUSTODY_SHA256, None, page_no=4, page_item_ordinal=6)],
        state,
        selector_policy=g11c4.SEED_SELECTOR_POLICY,
    )
    assert result.excluded_global_row_ordinals == (36,)
    assert result_state.excluded_rows == 1
    assert g11c4.TARGET_CUSTODY_SHA256 not in result_state.identity_map

    with raises(g11c4.GateError, match="SEALED_SELECTOR_SCOPE_VIOLATION"):
        g11c4.project_hashed_rows(
            [row(1, g11c4.TARGET_CUSTODY_SHA256, None, page_no=1)],
            selector_policy=g11c4.SEED_SELECTOR_POLICY,
        )
...
def test_future_selector_match_requires_raw_custody_then_stops_pending_owner() -> None:
    ...
    with raises(g11c4.FutureSelectorObservationError) as captured:
        g11c4.project_hashed_rows(
            [row(41, g11c4.TARGET_CUSTODY_SHA256, h("changed identity"))],
            original,
            raw_ref=raw_ref(),
            require_sealed_raw=True,
            selector_policy=g11c4.FUTURE_SELECTOR_POLICY,
        )
...
def test_future_selector_cannot_be_observed_before_raw_seal() -> None:
    with raises(g11c4.GateError, match="RAW_NOT_SEALED"):
        g11c4.project_hashed_rows(
            [row(41, g11c4.TARGET_CUSTODY_SHA256, None)],
            seeded_state(),
            require_sealed_raw=True,
        )
...
def test_non_target_conflict_and_missing_fields_fail_transactionally_after_raw_seal() -> None:
    original = seeded_state()
    with raises(g11c4.NonTargetIdentityConflictError):
        g11c4.project_hashed_rows(
    ...
    with raises(g11c4.MissingCustodyError):
        g11c4.project_hashed_rows(
    ...
    with raises(g11c4.MissingIdentityError):
        g11c4.project_hashed_rows(
...
def test_budget_exact_boundaries_and_per_page_attempt_gate() -> None:
    last = g11c4.BudgetState(g11_acquisitions=1695, g11_attempts=1995)
    ...
    with raises(g11c4.GateError, match="ACQUISITION_CEILING"):
        terminal.reserve_attempt(new_unique_acquisition=True, page_attempt=1)
    with raises(g11c4.GateError, match="ATTEMPTS_PER_PAGE_CEILING"):
        g11c4.BudgetState().reserve_attempt(new_unique_acquisition=True, page_attempt=3)


def test_append_only_namespace_guard_rejects_historical_keys() -> None:
    g11c4.validate_g11_object_key(
        "raw/public-data-api/source/G11C4/20260901143300/page-5.json"
    )
    with raises(g11c4.GateError, match="HISTORICAL_NAMESPACE_WRITE_FORBIDDEN"):
        g11c4.validate_g11_object_key(
            "raw/public-data-api/source/G10/G11C4/20260901143300/page-5.json"
        )


def test_active_raw_and_control_prefixes_reject_g11_g11c1_g11c2() -> None:
    g11c4.validate_active_c3_prefixes(g11c4.G11_RAW_PREFIX, g11c4.G11_CONTROL_PREFIX)
    for historical in ("G11", "G11C1", "G11C2"):
        old_raw = g11c4.G11_RAW_PREFIX.replace("G11C4", historical)
        old_control = g11c4.G11_CONTROL_PREFIX.replace("G11C4", historical)
        with raises(g11c4.GateError, match="HISTORICAL_ACTIVE_PREFIX_FORBIDDEN"):
            g11c4.validate_active_c3_prefixes(old_raw, g11c4.G11_CONTROL_PREFIX)
        with raises(g11c4.GateError, match="HISTORICAL_ACTIVE_PREFIX_FORBIDDEN"):
            g11c4.validate_active_c3_prefixes(g11c4.G11_RAW_PREFIX, old_control)
...
def test_precheck_receipt_append_and_execution_roles_are_not_collapsed() -> None:
    ...
    g11c4.validate_precheck_pass_role_binding(binding, receipt)

    collapsed = dict(binding)
    collapsed["receipt_append_commit"] = "a" * 40
    collapsed["receipt_append_tree"] = "b" * 40
    with raises(g11c4.GateError, match="PRECHECK_LINEAGE_ROLES_COLLAPSED"):
        g11c4.validate_precheck_pass_role_binding(collapsed, receipt)

    swapped = dict(binding)
    swapped["execution_head_sha"] = "c" * 40
    with raises(g11c4.GateError, match="execution_head_sha"):
        g11c4.validate_precheck_pass_role_binding(swapped, receipt)

    ambiguous = {**binding, "commit": "c" * 40, "tree": "d" * 40}
    with raises(g11c4.GateError, match="AMBIGUOUS_PRECHECK_LINEAGE_FIELDS"):
        g11c4.validate_precheck_pass_role_binding(ambiguous, receipt)


def test_sealed_adapter_dynamic_import_registers_dataclass_module_and_factory() -> None:
    adapter_path = MODULE_DIR / "finance_page100_g11c4_live_adapter.py"
    factory = g11c4.load_sealed_live_adapter_factory(
        adapter_path, g11c4.sha256_file(adapter_path)
    )
    assert callable(factory)
    assert factory.__name__ == g11c4.LIVE_ADAPTER_FACTORY_SYMBOL
...
def test_runtime_live_head_markers_resolve_only_from_exact_github_environment() -> None:
    ...
    activation = {
        "activation_binding": {
            "live_activation_commit": g11c4.LIVE_HEAD_MARKER,
            "live_activation_tree": g11c4.LIVE_TREE_MARKER,
            "expected_branch_head_at_dispatch": g11c4.LIVE_HEAD_MARKER,
        }
    }
    observed = g11c4.validate_runtime_live_head_binding(
        activation,
        environment={
            "G11C4_LIVE_HEAD_SHA": head,
            "G11C4_LIVE_HEAD_TREE": tree,
            "GITHUB_SHA": head,
    ...
    with raises(g11c4.GateError, match="live activation commit marker"):
        g11c4.validate_runtime_live_head_binding(
            embedded,
            environment={
                "G11C4_LIVE_HEAD_SHA": head,
                "G11C4_LIVE_HEAD_TREE": tree,
    ...
    with raises(g11c4.GateError, match="GITHUB_SHA"):
        g11c4.validate_runtime_live_head_binding(
            activation,
            environment={
                "G11C4_LIVE_HEAD_SHA": head,
...
def test_live_result_binds_actual_execution_and_single_terminal_put() -> None:
    ...
    def object_binding(name: str, *, key: str | None = None) -> dict:
        return {
            "key": key or f"raw/public-data-api/source/G11C4/{g11c4.GENERATION_TIMESTAMP}/{name}.json",
    ...
    effects = dict(g11c4.LIVE_PRE_ENTRY_EFFECTS)
    effects.update({
    ...
    result = {
        "schema": "M3TOP3_FINANCE_CA_PAGE100_G11C4_LIVE_ENTRY_RESULT_v1.0",
        "verdict": "PASS",
        "entry_gate": "LIVE_ENTERED_ONCE",
        "execution_binding": execution,
        "effects": effects,
        "effect_reconciliation": {"complete": True, "ambiguous_side_effects": False},
        "execution_claim_binding": object_binding("claim", key=g11c4.EXECUTION_CLAIM_KEY),
        "checkpoint_binding": object_binding("checkpoint", key=g11c4.G11_CHECKPOINT_KEY),
        "terminal_receipt_binding": {
            "key": g11c4.G11_TERMINAL_RECEIPT_KEY,
            "attempted": True,
            "put_attempts": 1,
            "confirmed": True,
            "object": object_binding("terminal", key=g11c4.G11_TERMINAL_RECEIPT_KEY),
        },
    }
    code, normalized = g11c4._normalize_and_validate_live_result(
    ...
    with raises(g11c4.GateError, match="terminal receipt attempt/write"):
        g11c4._normalize_and_validate_live_result(
            invalid, 0, expected_execution_binding=execution
        )


def test_pre_entry_live_result_preserves_three_session_effect_ledger() -> None:
    result = g11c4._pre_entry_live_failure("TEST_PRE_ENTRY_GATE")

    code, normalized = g11c4._normalize_and_validate_live_result(
        result, g11c4.EX_CONFIG
    )

    assert code == g11c4.EX_CONFIG
...
def test_seed_summary_reuses_sealed_receipts_and_defers_raw_recheck_to_live() -> None:
    assert g11c4.validate_seed_document(seed_document()) == "SEALED_RECEIPT_REUSE"


def test_plan_must_bind_exact_current_seed_sha_and_blob() -> None:
    with tempfile.TemporaryDirectory() as temporary_directory:
        seed_path = Path(temporary_directory) / g11c4.SEED_FILENAME
        write_json(seed_path, seed_document())
        plan = plan_document(seed_path)
        g11c4.validate_plan_seed_material_binding(plan, seed_path)
        write_json(seed_path, {**seed_document(), "state": "mutated-after-plan-binding"})
        with raises(g11c4.GateError, match="checkpoint_seed_sha256"):
            g11c4.validate_plan_seed_material_binding(plan, seed_path)
...
def test_live_session_policy_ascii_and_2048_character_limit() -> None:
    with tempfile.TemporaryDirectory() as temporary_directory:
        ...
        policies = g11c4.expected_split_session_policies()
        for role, policy in policies.items():
            write_json(policy_path, policy)
            exact_length = g11c4.validate_live_session_policy_for_aws(policy_path, role)
            assert exact_length <= 2048

        original_ceiling = g11c4.AWS_INLINE_SESSION_POLICY_ASCII_CHARACTER_CEILING
        try:
            role = "final_list_write_session_policy"
            write_json(policy_path, policies[role])
            exact_length = g11c4.validate_live_session_policy_for_aws(policy_path, role)
            g11c4.AWS_INLINE_SESSION_POLICY_ASCII_CHARACTER_CEILING = exact_length - 1
            with raises(g11c4.GateError, match="LIVE_SESSION_POLICY_EXCEEDS"):
                g11c4.validate_live_session_policy_for_aws(policy_path, role)
        finally:
            g11c4.AWS_INLINE_SESSION_POLICY_ASCII_CHARACTER_CEILING = original_ceiling
        ...
        with raises(g11c4.GateError, match="VERSION_MUST_BE_OMITTED"):
            g11c4.validate_live_session_policy_for_aws(
                policy_path, "checkpoint_read_session_policy"
            )


def test_bundle_hash_bindings_and_precheck_sts_effect_contract() -> None:
    placeholder_cap = g11c4.OWNER_CAP_SPEC_SHA256
    placeholder_token = g11c4.EXECUTION_TOKEN_SHA256
    g11c4.OWNER_CAP_SPEC_SHA256 = g11c4.sha256_bytes(
        g11c4.canonical_json_lf_bytes(g11c4.expected_owner_cap_spec())
    )
    g11c4.EXECUTION_TOKEN_SHA256 = g11c4.sha256_bytes(
        g11c4.canonical_json_lf_bytes(g11c4.expected_execution_token_material())
    )
    with tempfile.TemporaryDirectory() as temporary_directory:
        tmp_path = Path(temporary_directory)
        authority_path = tmp_path / g11c4.AUTHORITY_FILENAME
        plan_path = tmp_path / g11c4.PLAN_FILENAME
        seed_path = tmp_path / g11c4.SEED_FILENAME
        manifest_path = tmp_path / g11c4.MANIFEST_FILENAME
        policy_filenames = {
            "checkpoint_read_session_policy":
                "M3TOP3_FINANCE_CA_PAGE100_G11C4_CHECKPOINT_READ_SESSION_POLICY_v1.0.json",
            "raw_four_read_session_policy":
                "M3TOP3_FINANCE_CA_PAGE100_G11C4_RAW_FOUR_READ_SESSION_POLICY_v1.0.json",
            "final_list_write_session_policy":
                "M3TOP3_FINANCE_CA_PAGE100_G11C4_FINAL_LIST_WRITE_SESSION_POLICY_v1.0.json",
        }
        ...
        runner_path = Path(g11c4.__file__).resolve()
        adapter_path = MODULE_DIR / "finance_page100_g11c4_live_adapter.py"
        ...
        manifest = {
            "artifact": g11c4.MANIFEST_SCHEMA,
            "schema_version": 1,
            "generation_timestamp": g11c4.GENERATION_TIMESTAMP,
            "generation_id": g11c4.GENERATION_ID,
            "authority_commit": g11c4.AUTHORITY_COMMIT,
            ...
            "sealed_scope_summary": {
                "owner_cap_spec_sha256": g11c4.OWNER_CAP_SPEC_SHA256,
                "execution_token_sha256": g11c4.EXECUTION_TOKEN_SHA256,
                "fixed_quota_day_kst": g11c4.QUOTA_DAY_KST,
            },
            "adapter_execution_order_binding": g11c4.expected_adapter_execution_order(),
            "files": {
        ...
        assert result["governed_correction_head"] == g11c4.GOVERNED_CORRECTION_HEAD
        assert result["live_adapter_gate"] == g11c4.LIVE_ADAPTER_GATE_READY
        assert g11c4.PRECHECK_STS_PROBE_EFFECTS["aws_calls"] == 6
        assert g11c4.PRECHECK_STS_PROBE_EFFECTS["sts_calls"] == 6
        assert g11c4.PRECHECK_STS_PROBE_EFFECTS["s3_calls"] == 0
        assert g11c4.PRECHECK_STS_PROBE_EFFECTS["provider_calls"] == 0
        assert g11c4.PRECHECK_STS_PROBE_EFFECTS["remote_custody_mutations"] == 0

        blocked = dict(manifest)
        blocked["live_adapter_gate"] = g11c4.LIVE_ADAPTER_GATE_BLOCKED
        blocked_manifest = tmp_path / ("blocked-" + g11c4.MANIFEST_FILENAME)
        write_json(blocked_manifest, blocked)
        with raises(g11c4.GateError, match="manifest.live_adapter_gate"):
            g11c4.validate_manifest_document(
                blocked,
                authority_path=authority_path,
                plan_path=plan_path,
                seed_path=seed_path,
    ...
    g11c4.OWNER_CAP_SPEC_SHA256 = placeholder_cap
    g11c4.EXECUTION_TOKEN_SHA256 = placeholder_token
...
def test_unsealed_owner_decision_v11_binding_fails_closed() -> None:
    ...
    with raises(g11c4.GateError, match="UNSEALED_AUTHORITY_PLACEHOLDER"):
        g11c4.validate_authority_document(authority)


def test_precheck_requires_exact_three_workflow_proven_sts_policy_probes() -> None:
    assert g11c4.validate_precheck_sts_policy_probe_count(3) == 3
    for invalid in (None, False, 0, 1, 2, 4):
        with raises(g11c4.GateError, match="STS_POLICY_PROBE|EXACT_BINDING"):
            g11c4.validate_precheck_sts_policy_probe_count(invalid)
    assert g11c4.PRECHECK_STS_PROBE_EFFECTS == {
        **g11c4.ZERO_EFFECTS,
        "aws_calls": 6,
        "sts_calls": 6,
        "sts_assume_role_attempts": 3,
    ...
    assert [probe["role"] for probe in g11c4.OIDC_STS_POLICY_PACKING_PROBES] == [
        "CHECKPOINT_READ", "RAW_READ", "FINAL_LIST_WRITE",
    ]
    expected_observation_roles = [
        probe["role"] for probe in g11c4.OIDC_STS_POLICY_PACKING_PROBES
    ]
