#!/usr/bin/env python3
"""Fail-closed core and focused PRECHECK for the Finance Page100 G11C9 successor.
...
GENERATION_TIMESTAMP = "20260901200940"
GENERATION_ID = f"FINANCE-PAGE100-G11C9-{GENERATION_TIMESTAMP}"
RUNTIME_LOCK_ID = f"PMO-FINANCE-PAGE100-G11C9-{GENERATION_TIMESTAMP}"
PILOT_RUN_ID = f"FINANCE-PAGE100-PILOT-G11C9-{GENERATION_TIMESTAMP}"
PREPARATION_ID = f"FINANCE-PAGE100-G11C9-PREPARATION-{GENERATION_TIMESTAMP}"
PRECHECK_ACT_ID = f"FINANCE-PAGE100-PRECHECK-ACT-G11C9-{GENERATION_TIMESTAMP}"
LIVE_ACT_ID = f"FINANCE-PAGE100-LIVE-ACT-G11C9-{GENERATION_TIMESTAMP}"
LATCH_EVENT_ID = f"FINANCE-PAGE100-LATCH-G11C9-{GENERATION_TIMESTAMP}"
...
ACTIVATION_BASE_HEAD_COMMIT = "39a674ac8fc2d6af25e23f533f9f3379f81e4b6c"
ACTIVATION_BASE_TREE = "9f3905bd6aa25617c5b2f93e137a9ac281c3dc7b"
...
OWNER_CAP_SPEC_SHA256 = "c2df5290d66beebade5c17717d41fec4d26f5f78487d23902f4fdbe72d53e31e"
EXECUTION_TOKEN_SHA256 = "6db13e47d9bf12142d6ac6e29f63c8ce09f198cfeabf54553462f3e6ee56f4e2"
...
PREDECESSOR_G11C8_BINDING_CANONICAL_SHA256 = (
    "42c2f12cfabbd9af1843e53176ac9f673801caf6bc0c3b2d3bd11ce060fb8385"
)
PREDECESSOR_G11C8_INVALIDATION_RECEIPT_GIT_BLOB = "2323c6c4476e56afe682bc862dd2542b389483e0"
PREDECESSOR_G11C8_INVALIDATION_RECEIPT_SHA256 = (
    "3e39861b0149074769a354361123f9d98c411024b219c4394cc4f2108b6b17f8"
)
PREDECESSOR_G11C8_INVALIDATION_PAYLOAD_SHA256 = (
    "94211f2abde784c5184aaedec28e536066d954be1ee2b6a50742b5277ae89039"
)
PREDECESSOR_G11C8_IDENTITIES = {
    "consumed_generation_ids": ("FINANCE-PAGE100-G11C8-20260901184500",),
    "consumed_runtime_lock_ids": ("PMO-FINANCE-PAGE100-G11C8-20260901184500",),
    "consumed_pilot_run_ids": ("FINANCE-PAGE100-PILOT-G11C8-20260901184500",),
    "consumed_preparation_ids": ("FINANCE-PAGE100-G11C8-PREPARATION-20260901184500",),
    "consumed_precheck_act_ids": ("FINANCE-PAGE100-PRECHECK-ACT-G11C8-20260901184500",),
    "consumed_live_act_ids": ("FINANCE-PAGE100-LIVE-ACT-G11C8-20260901184500",),
    "consumed_latch_event_ids": ("FINANCE-PAGE100-LATCH-G11C8-20260901184500",),
}
...
AUTHORITY_FILENAME = (
    "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0.json"
)
PLAN_FILENAME = "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_PLAN_v1.0.json"
SEED_FILENAME = (
    "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0.json"
)
MANIFEST_FILENAME = (
    "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0.json"
)

AUTHORITY_SCHEMA = "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_AUTHORITY_v1.0"
PLAN_SCHEMA = "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_PLAN_v1.0"
SEED_SCHEMA = "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_CHECKPOINT_SEED_v1.0"
MANIFEST_SCHEMA = "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_MANIFEST_v1.0"

LIVE_ADAPTER_GATE_BLOCKED = "BLOCKED_MISSING_EXECUTABLE_CUSTODY_ADAPTERS"
LIVE_ADAPTER_GATE_READY = "READY"
LIVE_ADAPTER_REPO_PATH = "tools/m3top3/finance_page100_g11c9_live_adapter.py"
LIVE_ADAPTER_INTERFACE_VERSION = "M3TOP3_FINANCE_CA_PAGE100_G11C9_LIVE_ADAPTER_v1.0"
LIVE_ADAPTER_FACTORY_SYMBOL = "create_sealed_g11c9_custody_adapter"
LIVE_ADAPTER_TEST_REPO_PATH = "tools/m3top3/tests/test_finance_page100_g11c9_live_adapter.py"
...
REQUIRED_NO_RERUN_RUNS = (
    ...
    33484842311,  # consumed G11C6 PRECHECK; pre-OIDC message-case terminal failure
    ...
    33498757471,  # consumed G11C8 PRECHECK; pre-LIVE contract invalidation
)
ACTIVE_PREFIX_REJECTION_REGRESSIONS = (
    "G11", "G11C1", "G11C2", "G11C3", "G11C4", "G11C5", "G11C6", "G11C7", "G11C8",
)
HISTORICAL_SUCCESSOR_NAMESPACE_MARKERS = (
    ...
    "FINANCE-PAGE100-G11C8-",
    "PMO-FINANCE-PAGE100-G11C8-",
)
...
def predecessor_terminal_g11c6_binding() -> dict[str, Any]:
    """Return the exact terminal G11C6 pre-OIDC message-case failure binding."""

    return dict(PREDECESSOR_G11C6_BINDING)


def validate_predecessor_terminal_g11c6_binding(
    document: Mapping[str, Any], label: str,
) -> None:
    binding = document.get("predecessor_terminal_g11c6_binding")
    _require(isinstance(binding, Mapping), "G11C6_TERMINAL_BINDING_MISSING",
             f"{label}.predecessor_terminal_g11c6_binding is required")
    _require_exact(
        dict(binding), predecessor_terminal_g11c6_binding(),
        f"{label}.predecessor_terminal_g11c6_binding",
    )


def validate_predecessor_terminal_g11c7_binding(
    document: Mapping[str, Any], label: str,
) -> None:
    """Require the exact 85-field durable G11C7 LIVE terminal binding."""

    binding = document.get("predecessor_terminal_g11c7_binding")
    _require(isinstance(binding, Mapping), "G11C7_TERMINAL_BINDING_MISSING",
             f"{label}.predecessor_terminal_g11c7_binding is required")
    _require_exact(
        sha256_bytes(canonical_json_lf_bytes(dict(binding))),
        PREDECESSOR_G11C7_BINDING_CANONICAL_SHA256,
        f"{label}.predecessor_terminal_g11c7_binding canonical sha256",
    )

def validate_predecessor_invalidated_g11c8_binding(
    document: Mapping[str, Any], label: str,
) -> None:
    """Require the exact durable G11C8 pre-LIVE invalidation binding."""

    binding = document.get("predecessor_invalidated_g11c8_binding")
    _require(isinstance(binding, Mapping), "G11C8_INVALIDATION_BINDING_MISSING",
             f"{label}.predecessor_invalidated_g11c8_binding is required")
    _require_exact(
        sha256_bytes(canonical_json_lf_bytes(dict(binding))),
        PREDECESSOR_G11C8_BINDING_CANONICAL_SHA256,
        f"{label}.predecessor_invalidated_g11c8_binding canonical sha256",
    )
...
def validate_consumed_predecessor_identities(
    ...
    """Require every G11C1 through G11C7 identity/execution to remain consumed."""
    ...
    for field_name, expected_values in PREDECESSOR_G11C7_IDENTITIES.items():
        ...
        _require(
            isinstance(observed, list) and all(value in observed for value in expected_values),
            "G11C7_IDENTITY_NO_RERUN_BINDING_MISSING",
            f"{label}.{field_name} must include all terminal G11C7 identities",
        )
    for key, expected in {
        ...
        _require_exact(no_rerun.get(key), expected, f"{label}.{key}")
    for field_name, expected_values in PREDECESSOR_G11C8_IDENTITIES.items():
        observed = no_rerun.get(field_name)
        _require(
            isinstance(observed, list) and all(value in observed for value in expected_values),
            "G11C8_IDENTITY_NO_RERUN_BINDING_MISSING",
            f"{label}.{field_name} must include all invalidated G11C8 identities",
        )
    for key, expected in {
    ...
    for field_name, expected_values in PREDECESSOR_G11C6_IDENTITIES.items():
        ...
        _require(
            isinstance(observed, list) and all(value in observed for value in expected_values),
            "G11C6_IDENTITY_NO_RERUN_BINDING_MISSING",
            f"{label}.{field_name} must include all terminal G11C6 identities",
        )
    for key, expected in {
...
def validate_live_session_policy_for_aws(
    ...
    _require("Version" not in parsed, "LIVE_SESSION_POLICY_VERSION_MUST_BE_OMITTED",
             "G11C9 inline policy must use the permission-equivalent default version")
    _require("${" not in source_text, "LIVE_SESSION_POLICY_VARIABLE_FORBIDDEN",
             "G11C9 inline policy may not contain policy variables")
    expected = (
...
def load_sealed_live_adapter_factory(adapter_path: Path, expected_sha256: str) -> Any:
    ...
    module_name = f"_m3top3_g11c9_live_adapter_{expected_sha256}"
    try:
...
def validate_g11_object_key(key: str) -> None:
    """Reject writes outside the fresh G11C9 namespace or historical namespaces."""

    _require(isinstance(key, str) and bool(key), "INVALID_G11_OBJECT_KEY", "object key is empty")
    _require("G11C9" in key and GENERATION_TIMESTAMP in key,
             "INVALID_G11_OBJECT_KEY", "key is not bound to the fresh G11C9 generation")
    for forbidden in (
...
def validate_active_c9_prefixes(raw_prefix: Any, control_prefix: Any) -> None:
    """Reject any G11 through G11C7 namespace as the active G11C9 route."""
...
def validate_authority_document(document: Mapping[str, Any]) -> None:
    ...
    validate_predecessor_terminal_g11c6_binding(document, "authority")
    validate_predecessor_terminal_g11c7_binding(document, "authority")
    validate_predecessor_invalidated_g11c8_binding(document, "authority")
...
def expected_owner_cap_spec() -> dict[str, Any]:
    return {
        "schema": "M3TOP3_FINANCE_CA_PAGE100_G11C9_OWNER_CAP_SPEC_v1.0",
        ...
        "predecessor_g11c6_terminal_receipt_sha256":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_sha256"],
        "predecessor_g11c6_terminal_receipt_payload_sha256":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_payload_sha256"],
        "predecessor_g11c6_precheck_run_id": 33484842311,
        "predecessor_g11c6_precheck_job_id": 99782407546,
        "predecessor_g11c6_activation_sha256":
            PREDECESSOR_G11C6_BINDING["precheck_activation_sha256"],
        "predecessor_g11c7_terminal_receipt_append_commit": "0b21f3ffde00ea7f6705811954c729e35103a8db",
        "predecessor_g11c7_terminal_receipt_append_tree": "283ccf856dd34559a1fe8848808615ab4a3ba9ce",
        "predecessor_g11c7_terminal_receipt_sha256":
            "aa3464813c37e5bad3f98a8f51746a5431b03b0b2f0572e7f5863268fc707243",
        "predecessor_g11c7_terminal_receipt_payload_sha256":
            "de085c03034db98a6235aa5be95934c44ac7a8b5e2bd9af229cf72e2ec2a3356",
        "predecessor_g11c7_precheck_run_id": 33490803554,
        "predecessor_g11c7_live_run_id": 33492771321,
        "predecessor_g11c7_live_job_id": 99807892677,
        "predecessor_g11c7_live_activation_commit":
            "2b93cf1e62cb8278fe0d4025e6ded89b7983d91f",
        "predecessor_g11c7_live_activation_tree":
            "16e24984370d5cdf70b58904700990185aabf612",
        "checkout_fetch_depth": 33,
        "minimum_required_live_fetch_depth": 33,
        "predecessor_g11c8_terminal_checkpoint_commit": ACTIVATION_BASE_HEAD_COMMIT,
        "predecessor_g11c8_terminal_checkpoint_tree": ACTIVATION_BASE_TREE,
        "predecessor_g11c8_invalidation_receipt_sha256": PREDECESSOR_G11C8_INVALIDATION_RECEIPT_SHA256,
        "predecessor_g11c8_invalidation_receipt_payload_sha256": PREDECESSOR_G11C8_INVALIDATION_PAYLOAD_SHA256,
        "predecessor_g11c8_precheck_run_id": 33498757471,
        "predecessor_g11c8_precheck_job_id": 99826920605,
        "minimum_required_precheck_fetch_depth": 31,
        ...
        "g10_spent_primary_acquisitions": INHERITED_G10_ACQUISITIONS,
        "g10_spent_network_attempts": INHERITED_G10_ATTEMPTS,
        "maximum_new_g11c9_primary_acquisitions": G11_ACQUISITION_CEILING,
        "maximum_new_g11c9_network_attempts": G11_ATTEMPT_CEILING,
...
def expected_execution_token_material() -> dict[str, Any]:
    return {
        "schema": "M3TOP3_FINANCE_CA_PAGE100_G11C9_EXECUTION_TOKEN_MATERIAL_v1.0",
        "generation_id": GENERATION_ID,
        "runtime_lock_id": RUNTIME_LOCK_ID,
        "pilot_run_id": PILOT_RUN_ID,
        "preparation_id": PREPARATION_ID,
        ...
        "predecessor_g11c5_execution_head_tree_sha":
            PREDECESSOR_G11C5_PRECHECK_EXECUTION_HEAD_TREE_SHA,
        "predecessor_g11c6_terminal_receipt_append_commit":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_append_commit"],
        "predecessor_g11c6_terminal_receipt_append_tree":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_append_tree"],
        "predecessor_g11c6_terminal_receipt_path":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_path"],
        "predecessor_g11c6_terminal_receipt_git_blob":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_git_blob"],
        "predecessor_g11c6_terminal_receipt_sha256":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_sha256"],
        "predecessor_g11c6_terminal_receipt_payload_sha256":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_payload_sha256"],
        "predecessor_g11c6_terminal_receipt_bytes":
            PREDECESSOR_G11C6_BINDING["terminal_receipt_bytes"],
        "predecessor_g11c6_precheck_run_id": 33484842311,
        "predecessor_g11c6_precheck_job_id": 99782407546,
        "predecessor_g11c6_execution_head_sha":
            PREDECESSOR_G11C6_BINDING["execution_head_sha"],
        "predecessor_g11c6_execution_head_tree_sha":
            PREDECESSOR_G11C6_BINDING["execution_tree_sha"],
        "predecessor_g11c6_activation_path":
            PREDECESSOR_G11C6_BINDING["precheck_activation_path"],
        "predecessor_g11c6_activation_git_blob":
            PREDECESSOR_G11C6_BINDING["precheck_activation_git_blob"],
        "predecessor_g11c6_activation_sha256":
            PREDECESSOR_G11C6_BINDING["precheck_activation_sha256"],
        "predecessor_g11c6_activation_bytes":
            PREDECESSOR_G11C6_BINDING["precheck_activation_bytes"],
        "predecessor_g11c6_preparation_commit":
            PREDECESSOR_G11C6_BINDING["preparation_commit"],
        "predecessor_g11c6_preparation_tree":
            PREDECESSOR_G11C6_BINDING["preparation_tree"],
        "predecessor_g11c7_terminal_receipt_append_commit": "0b21f3ffde00ea7f6705811954c729e35103a8db",
        "predecessor_g11c7_terminal_receipt_append_tree": "283ccf856dd34559a1fe8848808615ab4a3ba9ce",
        "predecessor_g11c7_terminal_receipt_path":
            "control/m3top3/public-data-source-admission/v1.0/M3TOP3_FINANCE_CA_PAGE100_G11C7_ELIGIBLE_SUCCESSOR_LIVE_TERMINAL_RECEIPT_33492771321_v1.0.json",
        "predecessor_g11c7_terminal_receipt_git_blob":
            "cebebd9164fd3107331a7133a824b1a4ae7ce077",
        "predecessor_g11c7_terminal_receipt_sha256":
            "aa3464813c37e5bad3f98a8f51746a5431b03b0b2f0572e7f5863268fc707243",
        "predecessor_g11c7_terminal_receipt_payload_sha256":
            "de085c03034db98a6235aa5be95934c44ac7a8b5e2bd9af229cf72e2ec2a3356",
        "predecessor_g11c7_terminal_receipt_bytes": 15914,
        "predecessor_g11c7_precheck_run_id": 33490803554,
        "predecessor_g11c7_live_run_id": 33492771321,
        "predecessor_g11c7_live_job_id": 99807892677,
        "predecessor_g11c7_live_activation_commit":
        ...
        "predecessor_g11c8_terminal_checkpoint_commit": ACTIVATION_BASE_HEAD_COMMIT,
        "predecessor_g11c8_terminal_checkpoint_tree": ACTIVATION_BASE_TREE,
        "predecessor_g11c8_invalidation_receipt_path": (
            "control/m3top3/public-data-source-admission/v1.0/"
            "M3TOP3_FINANCE_CA_PAGE100_G11C8_PRE_LIVE_FROZEN_CONTRACT_AUDIT_"
            "TERMINAL_RECEIPT_20260901184500_v1.0.json"
        ),
        "predecessor_g11c8_invalidation_receipt_git_blob": PREDECESSOR_G11C8_INVALIDATION_RECEIPT_GIT_BLOB,
        "predecessor_g11c8_invalidation_receipt_sha256": PREDECESSOR_G11C8_INVALIDATION_RECEIPT_SHA256,
        "predecessor_g11c8_invalidation_receipt_payload_sha256": PREDECESSOR_G11C8_INVALIDATION_PAYLOAD_SHA256,
        "predecessor_g11c8_invalidation_receipt_bytes": 39836,
        "predecessor_g11c8_precheck_run_id": 33498757471,
        "predecessor_g11c8_precheck_job_id": 99826920605,
        "minimum_required_precheck_fetch_depth": 31,
        "standing_authority_issue": 49,
...
def validate_plan_document(document: Mapping[str, Any]) -> None:
    ...
    validate_predecessor_terminal_g11c6_binding(document, "plan")
    validate_predecessor_terminal_g11c7_binding(document, "plan")
    validate_predecessor_invalidated_g11c8_binding(document, "plan")
...
def validate_seed_document(document: Mapping[str, Any]) -> str:
    ...
    validate_predecessor_terminal_g11c6_binding(document, "seed")
    validate_predecessor_terminal_g11c7_binding(document, "seed")
    validate_predecessor_invalidated_g11c8_binding(document, "seed")
...
def _validate_zero_precheck_receipt(receipt: Mapping[str, Any]) -> str:
    ...
    match = re.fullmatch(
        r"M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_"
    ...
    _require_exact(
        ...
        "TERMINAL_PASS_FOCUSED_G11C9_PRECHECK_EXACT_3_OIDC_STS_POLICY_PACKING_"
    ...
    _require_exact(
        ...
        list(ACTIVE_PREFIX_REJECTION_REGRESSIONS),
...
def validate_runtime_live_head_binding(
    ...
    *,
    ...
    head_sha = env.get("G11C9_LIVE_HEAD_SHA", "")
    tree_sha = env.get("G11C9_LIVE_HEAD_TREE", "")
    _require(isinstance(head_sha, str) and HEX40.fullmatch(head_sha) is not None,
             "LIVE_RUNTIME_HEAD_INVALID", "G11C9_LIVE_HEAD_SHA")
    _require(isinstance(tree_sha, str) and HEX40.fullmatch(tree_sha) is not None,
             "LIVE_RUNTIME_TREE_INVALID", "G11C9_LIVE_HEAD_TREE")
    _require_exact(env.get("GITHUB_SHA"), head_sha, "GITHUB_SHA/G11C9_LIVE_HEAD_SHA")
...
def validate_live_activation_and_receipt(
    *,
    ...
    _require_exact(activation.get("artifact"),
                   "M3TOP3_FINANCE_CA_PAGE100_G11C9_ELIGIBLE_SUCCESSOR_LIVE_ACTIVATION_v1.0",
...
def _normalize_and_validate_live_result(
    ...
    *,
    ...
    _require_exact(output.get("schema"),
                   "M3TOP3_FINANCE_CA_PAGE100_G11C9_LIVE_ENTRY_RESULT_v1.0",
...
def _precheck(args: argparse.Namespace) -> tuple[int, dict[str, Any]]:
    ...
    return 0, {
        "schema": "M3TOP3_FINANCE_CA_PAGE100_G11C9_FOCUSED_PRECHECK_RESULT_v1.0",
        "verdict": "PASS",
        ...
        "observations": {
            ...
            "active_prefix_rejection_regressions": list(
                ACTIVE_PREFIX_REJECTION_REGRESSIONS
            ),
            "sts_policy_probe_count": STS_POLICY_PROBE_COUNT,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.mode == "live":
            ...
            result = {
                "schema": "M3TOP3_FINANCE_CA_PAGE100_G11C9_GATE_FAILURE_v1.0",
                "verdict": "FAIL_CLOSED",
