...
def run_audit(
    ...
    evidence = {
        ...
        "version_histories": {
            ...
            "all_delete_marker_counts": {"raw": len(inventories["raw"]["delete_markers"]), "control": len(inventories["control"]["delete_markers"]), "execution_claim": len(inventories["claim"]["delete_markers"])},
        },
